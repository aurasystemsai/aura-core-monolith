      ...
      {result && lga && (
        <div>
          ...
          {lga.typeGaps && lga.typeGaps.length > 0 && (
            <div style={S.card}>
              <div style={{ fontSize: 13, fontWeight: 700, marginBottom: 4 }}>🕳️ Types of sites linking to your competitors (but not you)</div>
...
function UnlinkedMentionsTab({ shopInfo = {} }) {
  ...
  return (
    <div>
      <FeatureExplainer icon="🏷️" title="Find people who mention you but forgot to include a link"
      ...
      {result && (
        <div>
          ...
          {result.toolsToUse && result.toolsToUse.length > 0 && (
            <div style={S.card}>
              <div style={{ fontSize: 13, fontWeight: 700, marginBottom: 4 }}>🛠️ Step 2: Tools that highlight broken links for you</div>
          ...
          <div style={S.grid2}>
            {result.contentToCreate && result.contentToCreate.length > 0 && (
              <div style={S.card}>
                <div style={{ fontSize: 12, fontWeight: 700, marginBottom: 6 }}>✍️ Content to create as the replacement</div>
