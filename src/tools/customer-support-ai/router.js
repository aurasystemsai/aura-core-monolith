...
router.post('/ai/generate', async (req, res) => {
	try {
		...
		const chatMessages = messages || [
			{ role: 'system', content: 'You are an expert AI for customer support.' },
...
router.get('/docs', (req, res) => {
	res.json({ ok: true, docs: 'Customer Support AI API: CRUD, AI, analytics, import/export, Shopify sync, notifications, RBAC, i18n.' });
});
