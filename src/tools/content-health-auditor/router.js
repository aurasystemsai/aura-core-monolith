...
// AI (OpenAI-powered content health audit)
...
router.get('/docs', (req, res) => {
  res.json({ ok: true, docs: 'Content Health Auditor API: CRUD, AI, analytics, import/export, Shopify sync, notifications, RBAC, i18n.' });
});
