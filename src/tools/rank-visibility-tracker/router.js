...
router.post('/ai/generate', async (req, res) => {
	try {
		...
		const chatMessages = messages || [
			{ role: 'system', content: 'You are an expert AI for rank visibility tracking.' },
...
router.get('/docs', (req, res) => {
	res.json({ ok: true, docs: 'Rank Visibility Tracker API: CRUD, AI, analytics, import/export, Shopify sync, notifications, RBAC, i18n.' });
});
