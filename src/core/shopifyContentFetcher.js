 ...
 *
 * Handles:
 *   /blogs/{blog-handle}/{article-handle}  â†’ Admin articles API
 *   /products/{product-handle}             â†’ Admin products API
 *   /pages/{page-handle}                   â†’ Admin pages API
 *
 ...
 * Checks session â†’ header â†’ URL hostname match â†’ single-store fallback â†’ env.
 */
...
/**
 * Main export â€” use this everywhere instead of bare fetch/node-fetch for HTML.
 *
