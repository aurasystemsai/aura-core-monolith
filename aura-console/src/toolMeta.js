...
const toolsMeta = [
 ...
 { id: "advanced-finance-inventory-planning", name: "Advanced Finance & Inventory Planning", description: "Monte Carlo simulations, P&L modelling, OTB planning and working capital analysis.", category: "Finance", suite: "finance" },
 { id: "daily-cfo-pack", name: "Daily CFO Pack", description: "Daily executive briefing with KPIs, P&L, cashflow and competitive benchmarks.", category: "Finance", suite: "finance" },
 ...
 { id: "visual-workflow-builder", name: "Visual Workflow Builder", description: "Design complex automation workflows with a drag-and-drop DAG builder.", category: "Automation", suite: "automation" },
 ...
 { id: "workflow-automation-builder", name: "Workflow Automation Builder", description: "Create rule-based automation with triggers, conditions and multi-step actions.", category: "Automation", suite: "automation" },
 { id: "workflow-orchestrator", name: "Workflow Orchestrator", description: "Orchestrate complex multi-step pipelines with retry policies and dependency management.", category: "Automation", suite: "automation" },
 ...
 { id: "conditional-logic-automation", name: "Conditional Logic Automation", description: "Build complex rule trees with nested if/else logic for advanced automation.", category: "Automation", suite: "automation" },
 ...
 { id: "ai-segmentation-engine", name: "AI Segmentation Engine", description: "Build dynamic customer segments with ML attributes, churn risk scoring and insights.", category: "AI", suite: "ai" },
