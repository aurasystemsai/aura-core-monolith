      ...
      <div className="aura-credits-pricing" style={{margin:'28px 0 12px',padding:'18px 18px 12px',background:'#18181b',borderRadius:14}}>
        ...
        <div style={{fontSize:15,marginBottom:10}}>
          ...
          <ul style={{margin:'8px 0 0 18px',padding:0,fontSize:15}}>
            ...
            <li><b>250 credits</b> = <b>$22 USD</b> <span style={{color:'#818cf8'}}>(save 12%)</span></li>
            <li><b>500 credits</b> = <b>$40 USD</b> <span style={{color:'#818cf8'}}>(save 20%)</span></li>
            <li><b>1000 credits</b> = <b>$75 USD</b> <span style={{color:'#818cf8'}}>(save 25%)</span></li>
          </ul>
          <span style={{color:'#818cf8'}}>No pay-as-you-go. Try the free tier or upgrade for more power.</span>
        </div>

        <div style={{background:'#18181b',borderRadius:10,padding:'22px 22px 18px',margin:'22px 0 0',fontSize:15,boxShadow:'0 4px 32px #0004'}}>
          <div style={{fontWeight:700,fontSize:16,marginBottom:8,color:'#818cf8'}}>Need more credits or advanced features?</div>
          ...
          <table style={{width:'100%',fontSize:15,background:'none',borderCollapse:'collapse',margin:'12px 0 10px'}}>
            <thead>
              <tr style={{color:'#818cf8',textAlign:'left'}}>
            ...
            <tbody>
              ...
              <tr style={{background:'rgba(127,255,212,0.18)',border:'2px solid #818cf8'}}>
                <td style={{padding:'4px 8px',fontWeight:900}}><b>Pro <span style={{background:'#818cf8',color:'#09090b',borderRadius:6,padding:'2px 8px',fontSize:13,marginLeft:4}}>Popular</span></b></td>
          ...
          <div style={{fontSize:15,margin:'18px 0 10px',background:'#18181b',borderRadius:10,padding:'14px 16px',color:'#fff',boxShadow:'0 2px 12px #22d3ee33'}}>
            <b style={{color:'#818cf8'}}>What our customers say:</b><br/>
          ...
          <div style={{fontSize:14,margin:'10px 0 8px'}}>
            <a href="https://aurasystemsai.com/pricing" target="_blank" rel="noopener" style={{color:'#818cf8',textDecoration:'underline',fontWeight:700}}>See all plans & features</a>
            <span style={{marginLeft:8,color:'#fff',fontSize:13,opacity:0.8}}>(No commitment, just info)</span>
          </div>
          <div style={{fontSize:14,margin:'10px 0 8px'}}>
            <b>What can you automate?</b><br/>
            <span style={{color:'#818cf8'}}>Search & SEO:</span>Product SEO Engine, Schema, Blog Engine, Alt-text Labeller<br/>
            <span style={{color:'#818cf8'}}>Email & Retention:</span>Automation Builder, Abandoned Checkout AI, Review Flows<br/>
            <span style={{color:'#818cf8'}}>Support & CX:</span>Inbox Reply Assistant, AI Support Agent, Returns Automation<br/>
            <span style={{color:'#818cf8'}}>Ops & Reporting:</span>Feed Hygiene Monitor, Rank Tracker, Daily CFO Pack
          </div>
          <div style={{fontSize:14,margin:'10px 0 8px'}}>
          ...
          <div style={{fontSize:13,opacity:0.85}}>
            <b>Need more?</b>Top up credits from £9 / 1,000 or <a href="https://aurasystemsai.com/get-started" style={{color:'#818cf8',textDecoration:'underline'}}>contact us</a> for custom plans.<br/>
            <span style={{color:'#818cf8'}}>Ready to upgrade?</span> <a href="https://aurasystemsai.com/get-started" style={{color:'#818cf8',textDecoration:'underline'}}>Get started here</a>.
          </div>
        </div>
        ...
        <div style={{fontSize:13,opacity:0.85}}>
          ...
          <span style={{color:'#818cf8'}}>No hidden fees. No subscriptions. Credits never expire.</span>
        </div>
      </div>
