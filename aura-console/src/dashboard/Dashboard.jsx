      ...
      <div className="dashboard-hero" style={{
        ...
        <div style={{display:'flex',flexDirection:'column',alignItems:'flex-start',flex:1,minWidth:260}}>
          <div style={{display:'flex',alignItems:'center',gap:18,marginBottom:12}}>
            <img src="logo-aura.png" alt="AURA Logo" style={{height:54,width:54,objectFit:'contain',borderRadius:12,boxShadow:'0 2px 16px #22d3ee55'}} onError={(e) => {e.target.onerror=null; e.target.src='logo192.png';}} />
          </div>
