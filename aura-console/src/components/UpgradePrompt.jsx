...
export function UpgradePrompt({ toolId, toolName, requiredPlan = 'professional'}) {
 ...
 <button 
 className="btn btn-primary btn-upgrade"onClick={() => navigate('/billing')}
 >
 Upgrade to {planNames[requiredPlan]}
 </button>
 <button 
 className="btn btn-secondary"onClick={() => navigate('/dashboard')}
 >
 Back to Dashboard
 </button>
 </div>
...
export function UpgradeBanner({ toolId, toolName, requiredPlan = 'professional'}) {
 ...
 <button 
 className="btn btn-sm btn-primary"onClick={() => navigate('/billing')}
 >
 Upgrade
 </button>
 </div>
