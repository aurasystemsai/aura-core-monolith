...
const ProductsList = ({ shopDomain, shopToken, plugins = [] }) => {
 ...
 className="pl-btn pl-btn--accent pl-btn--connect">Connect to Shopify</button>
 </div>
 {showDebug && <DebugPanel />}
 </div>
 );
 ...
 className="pl-thumb"style={{ width: 48, height: 48, objectFit: 'cover', borderRadius: 6, border: '1px solid var(--border-color)', background: 'var(--background-tertiary)'}}
 />
 ) : (
 ...
 <div className="pl-guide">SEO Title (4560 chars, include main keyword, no clickbait): This is the main headline for search engines and should be clear, descriptive, and unique for each product.</div>
 </>
 )}
 </td>
 <td>
 ...
 <div className="pl-guide">Meta Description (130155 chars, include main keyword): This summary appears in search results and should entice clicks while accurately describing the product.</div>
 </>
 )}
 </td>
 <td>
 ...
 <div className="pl-guide">Bullets: Key features or benefits. Use 35 concise points to help customers scan quickly.</div>
 </td>
 <td>
