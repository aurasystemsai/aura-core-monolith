...
function SystemHealthPanel({ coreStatus, coreStatusLabel, lastRunAt }) {
 ...
 const statusText =
 coreStatus === "ok"? "Core API online": coreStatus === "checking"? "Checking Core API": coreStatus === "error"? "Core API offline check server or API key": "Status not checked yet";

 const statusClass =
 coreStatus === "ok"? "system-health-chip system-health-chip--ok": coreStatus === "checking"? "system-health-chip system-health-chip--loading": coreStatus === "error"? "system-health-chip system-health-chip--error": "system-health-chip";
