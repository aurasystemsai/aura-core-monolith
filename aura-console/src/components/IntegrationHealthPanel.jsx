    ...
    <section className="integration-health-card" style={{ marginTop: 18, background: '#252638', borderRadius: 18, boxShadow: '0 4px 24px #0004', padding: '32px 36px', maxWidth: 540, marginLeft: 'auto', marginRight: 'auto' }}>
      <div className="card-header" style={{ marginBottom: 18 }}>
        <h2 className="card-title" style={{ fontSize: 22, fontWeight: 900, color: '#6366f1', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ display: 'inline-block', marginLeft: 8, fontSize: 18, color: '#6366f1', cursor: 'help' }} title="This panel shows if your Shopify integration is working. If green, all is well."></span>
        </h2>
        <p className="card-subtitle" style={{ color: '#b3c2e0', fontWeight: 500, fontSize: 15, marginTop: 6 }}>
          Shopify connection status for your app. If this is <span style={{color:'#6366f1',fontWeight:700}}>green</span>, your automations and analytics will work. If <span style={{color:'#ff4d4f',fontWeight:700}}>red</span>, check your app setup.
        </p>
      </div>
      <div className="integration-health-grid" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: 18 }}>
        {INTEGRATIONS.map((integration) => {
          ...
          if (status === "ok") {
            ...
            icon = <span style={{ color: '#6366f1', fontSize: 28, marginRight: 12 }}>️</span>;
