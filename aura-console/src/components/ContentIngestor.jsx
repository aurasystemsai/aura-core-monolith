...
function ContentIngestor({ coreUrl, projectId }) {
 ...
 const chipClass =
 status.tone === "ok"? "chip chip--ok": status.tone === "error"? "chip chip--error": status.tone === "loading"? "chip chip--loading": "chip";
 ...
 // Keep text there by default so beginners dont lose it accidentally.
 ...
 <span style={{color:'#4f46e5',marginLeft:8,cursor:'help'}} title="After ingesting, go to Content Health and hit Refresh to see your new items.">?</span>
 </p>
 </div>
 ...
 <span style={{color:'#4f46e5',marginLeft:4,cursor:'help'}} title="If you only paste URLs, this type will be used for all of them. Change to 'product', 'blog', etc as needed.">?</span>
 </div>
 <select
 className="inspector-input"value={typeDefault}
 ...
 <span style={{color:'#4f46e5',marginLeft:4,cursor:'help'}} title="See if your input is valid, and how many lines will be ingested.">?</span>
 </div>
 ...
 <textarea
 className="inspector-textarea"rows={10}
 value={bulkText}
 ...
 <button
 className="button button--primary"onClick={handleSubmit}
