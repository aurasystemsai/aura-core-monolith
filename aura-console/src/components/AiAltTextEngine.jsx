...
export default function AiAltTextEngine() {
  ...
  return (
    <div className="tool-ai-alt-text" style={{ maxWidth: 900, margin: "40px auto", background: "#09090b", color: "#f4f4f5", borderRadius: 18, boxShadow: "0 2px 24px #0002", padding: 36, fontFamily: 'Inter, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ maxWidth: 500 }}>
        ...
        <button type="submit" disabled={loading} style={{ background: "#4f46e5", color: "#09090b", border: "none", borderRadius: 8, padding: "10px 22px", fontWeight: 700, fontSize: 16, cursor: "pointer", marginTop: 12 }}>{loading ? "Generating..." : "AI Generate"}</button>
      </form>
      ...
      {batchResults.length > 0 && (
        <div style={{ background: "#f4f4f5", borderRadius: 12, padding: 18, marginBottom: 12 }}>
      ...
      <div style={{ marginTop: 24, background: "#f4f4f5", borderRadius: 12, padding: 18 }}>
        ...
        <div style={{ fontSize: 15, color: "#09090b" }}>
          {analytics.length ? (
            <pre style={{ whiteSpace: "pre-wrap", wordBreak: "break-word", background: "none", color: "#f4f4f5", padding: 0, margin: 0 }}>{JSON.stringify(analytics, null, 2)}</pre>
          ) : (
