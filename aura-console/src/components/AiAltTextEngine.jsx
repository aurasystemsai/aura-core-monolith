...
export default function AiAltTextEngine() {
  ...
  return (
    <div className="tool-ai-alt-text" style={{ maxWidth: 900, margin: "40px auto", background: "#0d0d11", color: "#f3f4f6", borderRadius: 18, boxShadow: "0 2px 24px #0002", padding: 36, fontFamily: 'Inter, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ maxWidth: 500 }}>
        ...
        <button type="submit" disabled={loading} style={{ background: "#6366f1", color: "#0d0d11", border: "none", borderRadius: 8, padding: "10px 22px", fontWeight: 700, fontSize: 16, cursor: "pointer", marginTop: 12 }}>{loading ? "Generating..." : "AI Generate"}</button>
      </form>
      <div style={{ display: "flex", gap: 12, margin: "18px 0" }}>
        <button onClick={() => fileInputRef.current?.click()} style={{ background: "#fbbf24", color: "#0d0d11", border: "none", borderRadius: 8, padding: "10px 22px", fontWeight: 700, fontSize: 16, cursor: "pointer" }}>Batch Upload</button>
