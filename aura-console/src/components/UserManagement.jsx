...
export default function UserManagement({ coreUrl }) {
  ...
  return (
    <div style={{ maxWidth: 400, margin: '40px auto', padding: 24, background: '#232b3b', borderRadius: 12 }}>
      ...
      <form onSubmit={handleRegister} style={{ marginBottom: 24 }}>
        ...
        <button type="submit" style={{ width: '100%', background: '#7fffd4', color: '#232b3b', fontWeight: 700, padding: 10, border: 0, borderRadius: 6 }}>Register User</button>
      </form>
