...
export default function AllTools({ setActiveSection }) {
 ...
 <div
 key={mod.id}
 className="tool-card"onClick={() => handleToolClick(mod.id, mod.categoryId)}
 ...
 <h3>{mod.name}</h3>
 <span
 className="category-tag"style={{ backgroundColor: tag.bg }}
 >
 {tag.text}
 </span>
 </div>
 ...
 <a
 href={mod.docUrl}
 target="_blank"rel="noopener noreferrer"className="doc-link"onClick={(e) => e.stopPropagation()}
 >
 Docs
 </a>
 )}
