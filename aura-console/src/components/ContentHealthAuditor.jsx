        ...
        <div className="cha-filters">
          <div className="cha-filter">
            <div className="cha-label" title="Choose which type of content to audit (products, blogs, etc)">Type
              <span style={{color:'#818cf8',marginLeft:4,cursor:'help'}} title="Select a content type to focus your audit. 'All' checks everything.">?</span>
            </div>
          ...
          <div className="cha-filter">
            <div className="cha-label" title="Show only items with a score at or below this value">Max score
              <span style={{color:'#818cf8',marginLeft:4,cursor:'help'}} title="Lower scores mean more issues. Set a max to focus on the worst content.">?</span>
            </div>
          ...
          <div className="cha-filter">
            <div className="cha-label" title="How many results to show at once">Limit
              <span style={{color:'#818cf8',marginLeft:4,cursor:'help'}} title="Set the maximum number of results to display. Useful for large stores.">?</span>
            </div>
