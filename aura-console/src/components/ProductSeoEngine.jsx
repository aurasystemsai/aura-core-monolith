...
function SerpPreview({ title, description, handle, shop, device }) {
  ...
  return (
    <div style={{ background: '#818cf8', borderRadius: 12, padding: isMobile ? '12px 14px' : '16px 20px', fontFamily: 'Arial, sans-serif', boxShadow: '0 2px 12px #0001' }}>
                      ...
                      <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start', paddingRight: 56 }}>
                        ...
                        <div style={{ minWidth: 0, flex: 1 }}>
                          ...
                          <div style={{ display: 'flex', gap: 6, marginTop: 8, flexWrap: 'wrap' }}>
                            ...
                            {hasData && <span style={{ fontSize: 11, padding: '2px 8px', borderRadius: 5, background: '#071a10', color: '#818cf8', border: '1px solid #818cf820', fontWeight: 600 }}>SEO ready</span>}
                      ...
                      {hasData && (
                        <div style={{ marginTop: 12, paddingTop: 10, borderTop: '1px solid #27272a' }}>
                          ...
                          <div style={{ display: 'flex', gap: 5, marginTop: 7, flexWrap: 'wrap' }}>
                            {pFields.seoTitle && <span style={{ fontSize: 10, color: '#818cf8', background: '#818cf809', border: '1px solid #818cf815', padding: '1px 6px', borderRadius: 4 }}>Title</span>}
                            {pFields.seoDescription && <span style={{ fontSize: 10, color: '#818cf8', background: '#818cf809', border: '1px solid #818cf815', padding: '1px 6px', borderRadius: 4 }}>Desc</span>}
                            {pFields.keywords && <span style={{ fontSize: 10, color: '#818cf8', background: '#818cf809', border: '1px solid #818cf815', padding: '1px 6px', borderRadius: 4 }}>Keywords</span>}
                            {pFields.altText && <span style={{ fontSize: 10, color: '#818cf8', background: '#818cf809', border: '1px solid #818cf815', padding: '1px 6px', borderRadius: 4 }}>Alt text</span>}
                          </div>
                        </div>
                      )}
                    </div>
                          ...
                          return [
                            ...
                            <div key={item.label} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '7px 10px', background: '#09090b', borderRadius: 8, marginBottom: 5 }}>
                              ...
                              <div style={{ display: 'flex', gap: 8 }}>
                                ...
                                <span style={{ fontSize: 11, fontWeight: 700, color: item.earned > 0 ? '#818cf8' : '#52525b', background: item.earned > 0 ? '#818cf810' : 'none', border: '1px solid ' + (item.earned > 0 ? '#818cf820' : '#27272a'), borderRadius: 4, padding: '1px 6px' }}>{item.earned}/{item.pts}</span>
                              </div>
                            </div>
                          ));
                        })()}
                  ...
                  <div style={{ maxWidth: 680 }}>
                    <div style={{ background: '#18181b', border: '1px solid #27272a', borderRadius: 16, padding: 22 }}>
                      ...
                      <div style={{ height: 6, background: '#27272a', borderRadius: 3, overflow: 'hidden', marginBottom: 18 }}>
                        <div style={{ height: '100%', width: ((checkPassed / checklist.length) * 100) + '%', background: 'linear-gradient(90deg, #818cf8, #4ade80)', borderRadius: 3, transition: 'width 0.4s ease' }} />
                      </div>
            ...
            {bulkGenerating && (
              <div style={{ background: '#18181b', border: '1px solid #27272a', borderRadius: 14, padding: 20, marginBottom: 20 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                  ...
                  <span style={{ fontSize: 14, color: '#818cf8', fontWeight: 700 }}>{bulkResults.length} / {bulkSelected.size}</span>
                </div>
                <div style={{ height: 8, background: '#27272a', borderRadius: 4, overflow: 'hidden' }}>
                  <div style={{ height: '100%', width: (bulkSelected.size ? (bulkResults.length / bulkSelected.size) * 100 : 0) + '%', background: 'linear-gradient(90deg, #818cf8, #22d3ee)', borderRadius: 4, transition: 'width 0.3s' }} />
                </div>
              </div>
            )}
        ...
        {tab === 'analytics' && (
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 14, marginBottom: 28 }}>
              {[
                { label: 'Total Products', value: products.length, colour: '#818cf8' },
                  ...
                  {products.filter(p => seoScore(stored[p.id] || {}) < 50).slice(0, 10).map(p => {
                    ...
                    return (
                      ...
                      onMouseLeave={e => e.currentTarget.style.background = '#09090b'}>
                        ...
                        <span style={{ fontSize: 12, color: '#818cf8', fontWeight: 700, whiteSpace: 'nowrap' }}>Fix it</span>
                      </div>
                    );
                  })}
                </div>
