                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                      ...
                      <FieldBlock label="SEO Title" hint="Shown in browser tab and Google search results" badge={<GenBtn onClick={() => generateField('seoTitle')} loading={!!fieldGenerating.seoTitle} />}>
                        <input value={editor.seoTitle} onChange={e => setEditor(ed => ({ ...ed, seoTitle: e.target.value }))}
                          ...
                          style={{ width: '100%', background: '#09090b', border: '1px solid ' + (editor.seoTitle.length > 60 ? '#f87171' : '#27272a'), borderRadius: 10, padding: '11px 14px', color: '#fafafa', fontSize: 15, outline: 'none', boxSizing: 'border-box' }} />
                      ...
                      <FieldBlock label="Image Alt Text" hint="Describe the main product image for accessibility and SEO" badge={<GenBtn onClick={() => generateField('altText')} loading={!!fieldGenerating.altText} small />}>
                        <input value={editor.altText} onChange={e => setEditor(ed => ({ ...ed, altText: e.target.value }))}
                          ...
                          style={{ width: '100%', background: '#09090b', border: '1px solid #27272a', borderRadius: 10, padding: '11px 14px', color: '#fafafa', fontSize: 14, outline: 'none', boxSizing: 'border-box' }} />
                      </FieldBlock>
                    </div>
                    ...
                    <div key={i} style={{ background: '#18181b', border: '1px solid ' + (r.status === 'ok' ? '#4ade8025' : '#f8717125'), borderRadius: 14, padding: 16 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          {r.status === 'ok'
                            ? <div style={{ fontSize: 12, color: '#71717a', marginTop: 2 }}>Score: <span style={{ color: rc, fontWeight: 700 }}>{r.score}/100</span></div>
