...
const Billing = () => {
 ...
 <button 
 className="btn-primary"onClick={() => setShowPlanModal(true)}
 >
 {subscription ? 'Change Plan': 'Upgrade Now'}
 </button>
 {subscription && subscription.status === 'active'&& (
 <button 
 className="btn-danger-outline"onClick={cancelSubscription}
 >
 Cancel Subscription
 </button>
 )}
 ...
 <td>
 <button 
 className="btn-icon"onClick={() => downloadInvoice(invoice.id)}
 title="Download PDF">
 <FaDownload />
 </button>
 </td>
