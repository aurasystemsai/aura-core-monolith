...
const SECTIONS = [
  ...
  { id: "products",     title: "Fix Products",        desc: "AI-fix product SEO: titles & meta",  icon: "🛍️", color: C.violet },
...
export default function SiteAuditFixer() {
  ...
  function SectionContent() {
      ...
      return (
        <div>
          ...
          <div style={{ display: "flex", gap: 16, marginBottom: 28, flexWrap: "wrap" }}>
            {[
              { label: "Products",    count: pagesWithIssues(productPages).length,    total: productPages.length,    section: "products",    icon: "🛍️" },
    ...
    const iconMap   = { products: "🛍️", pages: "📄", collections: "📂" };
