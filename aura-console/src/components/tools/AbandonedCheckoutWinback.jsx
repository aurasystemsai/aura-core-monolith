...
function AbandonedCheckoutWinbackLegacy() {
  ...
  const renderCategoryNav = () => (
    <div style={{ display: 'flex', gap: 12, marginBottom: 24, borderBottom: '2px solid #353848', paddingBottom: 12 }}>
      {categories.map(cat => (
        <button
          key={cat.id}
          onClick={() => {
          ...
          style={{
            background: activeCategory === cat.id ? '#6366f1' : '#1a1c25',
            color: '#f9fafb',
            border: activeCategory === cat.id ? '2px solid #6366f1' : '1px solid #353848',
            borderRadius: 8,
            padding: '10px 20px',
            fontWeight: 700,
            fontSize: 15,
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 18, flexWrap: 'wrap' }}>
        {currentTabs.map(tab => (
          <button
            ...
            style={{
              background: activeTab === tab.id ? '#353848' : '#1a1c25',
              color: activeTab === tab.id ? '#6366f1' : '#f9fafb',
              border: activeTab === tab.id ? '2px solid #6366f1' : '1px solid #353848',
              borderRadius: 6,
              padding: '8px 16px',
              fontWeight: 600,
              fontSize: 14,
...
function RecoveryCampaignsTab({ campaigns, setCampaigns }) {
  ...
  return (
    <div>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', background: '#353848', borderRadius: 10, overflow: 'hidden' }}>
        <thead style={{ background: '#1a1c25' }}>
          <tr>
        ...
        <tbody>
          {campaigns.length === 0 ? (
            ...
            <tr key={idx} style={{ borderTop: '1px solid #1a1c25' }}>
              ...
              <td style={{ padding: 12 }}>
                <button style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '6px 14px', fontSize: 14, cursor: 'pointer', marginRight: 6 }}>Edit</button>
                <button style={{ background: '#353848', color: '#ef4444', border: '1px solid #353848', borderRadius: 6, padding: '6px 14px', fontSize: 14, cursor: 'pointer' }}>Delete</button>
              </td>
            </tr>
          ))}
        </tbody>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 18, marginTop: 24 }}>
        <div style={{ background: '#353848', padding: 24, borderRadius: 10 }}>
        ...
        {workflows.length === 0 ? (
          ...
          <div style={{ display: 'grid', gap: 12 }}>
            {workflows.map((wf, idx) => (
              <div key={idx} style={{ background: '#353848', padding: 18, borderRadius: 8, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  <div style={{ fontWeight: 700 }}>{wf.name}</div>
                  <div style={{ fontSize: 14, color: '#a8adc4' }}>Status: {wf.status}</div>
                </div>
                <div>
                  <button style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '6px 14px', fontSize: 14, cursor: 'pointer' }}>Edit</button>
                </div>
              </div>
            ))}
          </div>
...
function ExportImportTab() {
  ...
  return (
    <div>
      ...
      <div style={{ background: '#353848', padding: 24, borderRadius: 10, marginBottom: 24 }}>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <select value={exportType} onChange={(e) => setExportType(e.target.value)} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', maxWidth: 300 }}>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <select value={exportFormat} onChange={(e) => setExportFormat(e.target.value)} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', maxWidth: 300 }}>
    ...
    <div>
      ...
      <div style={{ background: '#353848', padding: 24, borderRadius: 10 }}>
        <div style={{ marginBottom: 16 }}>
          ...
          <select value={method} onChange={(e) => setMethod(e.target.value)} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', maxWidth: 200 }}>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input type="text" value={endpoint} onChange={(e) => setEndpoint(e.target.value)} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', fontFamily: 'monospace' }} />
        </div>

        {method !== 'GET' && (
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: 'block', marginBottom: 8, fontSize: 14, fontWeight: 600 }}>Request Body (JSON)</label>
            <textarea value={body} onChange={(e) => setBody(e.target.value)} rows={8} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 14, width: '100%', fontFamily: 'monospace' }} />
          </div>
        )}
        ...
        {response && (
          <div>
            ...
            <pre style={{ background: '#1a1c25', color: '#22c55e', border: '1px solid #353848', borderRadius: 6, padding: 16, fontSize: 13, fontFamily: 'monospace', overflowX: 'auto', maxHeight: 400, overflowY: 'auto' }}>
              {response}
            </pre>
          </div>
        )}
    ...
    <div>
      ...
      {showForm && (
        <div style={{ background: '#353848', padding: 24, borderRadius: 10, marginBottom: 24 }}>
          ...
          <input type="text" placeholder="Webhook URL" style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', marginBottom: 12 }} />
          <select style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', marginBottom: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            ...
            <button onClick={() => setShowForm(false)} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '8px 16px', fontWeight: 600, cursor: 'pointer' }}>Cancel</button>
          </div>
        </div>
      )}
        ...
        <tbody>
          {webhooks.length === 0 ? (
            ...
            <tr key={idx} style={{ borderTop: '1px solid #1a1c25' }}>
              ...
              <td style={{ padding: 12 }}>
                <button style={{ background: '#1a1c25', color: '#ef4444', border: '1px solid #353848', borderRadius: 6, padding: '6px 14px', fontSize: 14, cursor: 'pointer' }}>Delete</button>
              </td>
            </tr>
          ))}
        </tbody>
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 18 }}>
        {integrations.map((int, idx) => (
          <div key={idx} style={{ background: '#353848', padding: 24, borderRadius: 10 }}>
  ...
  return (
    <div>
      ...
      <div style={{ background: '#353848', padding: 24, borderRadius: 10 }}>
        ...
        <select style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', maxWidth: 300, marginBottom: 16 }}>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 18, marginBottom: 24 }}>
        <div style={{ background: '#353848', padding: 20, borderRadius: 10 }}>
    ...
    <div>
      ...
      <div style={{ background: '#353848', padding: 24, borderRadius: 10 }}>
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ borderBottom: '2px solid #1a1c25' }}>
          ...
          <tbody>
            <tr style={{ borderBottom: '1px solid #1a1c25' }}>
...
function ActivityLogTab() {
  ...
  return (
    <div>
      ...
      <div style={{ background: '#353848', borderRadius: 10, overflow: 'hidden' }}>
        {activities.length === 0 ? (
          <div style={{ padding: 32, textAlign: 'center', color: '#64748b' }}>No activities yet</div>
        ) : (
          activities.map((activity, idx) => (
            <div key={idx} style={{ padding: 16, borderBottom: idx < activities.length - 1 ? '1px solid #1a1c25' : 'none' }}>
...
function AlertsTab() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gap: 12 }}>
        {alerts.length === 0 ? (
          <div style={{ background: '#353848', padding: 32, borderRadius: 10, textAlign: 'center', color: '#64748b' }}>No active alerts</div>
        ) : alerts.map((alert, idx) => (
          <div key={idx} style={{ background: '#353848', padding: 18, borderRadius: 10, borderLeft: `4px solid ${alert.severity === 'critical' ? '#ef4444' : alert.severity === 'warning' ? '#f59e0b' : '#6366f1'}` }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <div style={{ fontWeight: 700, marginBottom: 4 }}>{alert.title}</div>
                <div style={{ fontSize: 14, color: '#a8adc4' }}>{alert.message}</div>
              </div>
              <button style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '6px 14px', fontSize: 14, cursor: 'pointer' }}>Dismiss</button>
            </div>
          </div>
        ))}
      </div>
    ...
    <div>
      ...
      <div style={{ background: '#353848', padding: 24, borderRadius: 10 }}>
        <div style={{ marginBottom: 18 }}>
          ...
          <input type="text" value={settings.shopName} onChange={(e) => setSettings({...settings, shopName: e.target.value})} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', maxWidth: 400 }} />
        </div>
        <div style={{ marginBottom: 18 }}>
          <label style={{ display: 'block', marginBottom: 8, fontSize: 14, fontWeight: 600 }}>Timezone</label>
          <select value={settings.timezone} onChange={(e) => setSettings({...settings, timezone: e.target.value})} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <select value={settings.currency} onChange={(e) => setSettings({...settings, currency: e.target.value})} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', maxWidth: 400 }}>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gap: 18 }}>
        {brands.length === 0 ? (
          <div style={{ background: '#353848', padding: 32, borderRadius: 10, textAlign: 'center', color: '#64748b' }}>No brands configured</div>
        ) : brands.map((brand, idx) => (
          <div key={idx} style={{ background: '#353848', padding: 20, borderRadius: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
        ...
        <tbody>
          {teams.length === 0 ? (
            ...
            <tr key={idx} style={{ borderTop: '1px solid #1a1c25' }}>
              ...
              <td style={{ padding: 12 }}>
                <button style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '6px 14px', fontSize: 14, cursor: 'pointer' }}>Manage</button>
              </td>
            </tr>
          ))}
        </tbody>
...
function LocalizationTab() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gap: 12 }}>
        {locales.length === 0 ? (
          <div style={{ background: '#353848', padding: 32, borderRadius: 10, textAlign: 'center', color: '#64748b' }}>No locales configured. Add your first language!</div>
        ) : locales.map((locale, idx) => (
          <div key={idx} style={{ background: '#353848', padding: 18, borderRadius: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
        ...
        <tbody>
          {apiKeys.length === 0 ? (
            ...
            <tr key={idx} style={{ borderTop: '1px solid #1a1c25' }}>
              ...
              <td style={{ padding: 12 }}>
                <button style={{ background: '#1a1c25', color: '#ef4444', border: '1px solid #353848', borderRadius: 6, padding: '6px 14px', fontSize: 14, cursor: 'pointer' }}>Revoke</button>
              </td>
            </tr>
          ))}
        </tbody>
...
function CollaborationTab() {
  ...
  return (
    <div>
      ...
      <div style={{ background: '#353848', padding: 24, borderRadius: 10, marginBottom: 24 }}>
        <textarea placeholder="Add a comment..." rows={3} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '10px 14px', fontSize: 15, width: '100%', marginBottom: 12 }} />
      ...
      <div style={{ display: 'grid', gap: 12 }}>
        {comments.length === 0 ? (
          <div style={{ background: '#353848', padding: 32, borderRadius: 10, textAlign: 'center', color: '#64748b' }}>No comments yet</div>
        ) : comments.map((comment, idx) => (
          <div key={idx} style={{ background: '#353848', padding: 18, borderRadius: 10 }}>
        ...
        {auditLogs.length === 0 ? (
          ...
          <div style={{ fontSize: 14 }}>
            {auditLogs.slice(0, 5).map((log, idx) => (
              <div key={idx} style={{ padding: '10px 0', borderBottom: idx < 4 ? '1px solid #1a1c25' : 'none' }}>
        ...
        {scripts.length === 0 ? (
          ...
          <div style={{ display: 'grid', gap: 12 }}>
            {scripts.map((script, idx) => (
              <div key={idx} style={{ background: '#1a1c25', padding: 18, borderRadius: 8, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  <div style={{ fontWeight: 700 }}>{script.name}</div>
                  <div style={{ fontSize: 14, color: '#a8adc4' }}>Trigger: {script.trigger}</div>
                </div>
                <button style={{ background: '#353848', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '6px 14px', fontSize: 14, cursor: 'pointer' }}>Edit</button>
              </div>
            ))}
          </div>
        )}
...
function OnboardingBanner() {
  ...
  return (
    <div style={{ background: '#6366f1', color: '#fff', borderRadius: 10, padding: 18, marginBottom: 18, display: 'flex', alignItems: 'center', justifyContent: 'space-between', boxShadow: '0 2px 8px #0004' }}>
      ...
      <button onClick={handleDismiss} style={{ background: '#1a1c25', color: '#fff', border: 'none', borderRadius: 6, padding: '6px 16px', fontWeight: 600, fontSize: 15, cursor: 'pointer', marginLeft: 18 }}>Dismiss</button>
    </div>
  );
}
    ...
    <div style={{ display: 'flex', gap: 18, margin: '18px 0 18px 0', alignItems: 'center' }}>
      {stages.map(stage => (
        <button
          ...
          style={{
            background: selectedStage === stage.key ? '#353848' : '#1a1c25',
            color: '#f9fafb',
            border: selectedStage === stage.key ? '2px solid #6366f1' : '1px solid #353848',
            borderRadius: 8,
            padding: '10px 18px',
            fontWeight: 600,
            fontSize: 15,
...
function NotificationsSection() {
  ...
  return (
    <section aria-label="Notifications">
      ...
      <div style={{ background: '#222535', color: '#f9fafb', borderRadius: 14, boxShadow: '0 2px 8px #0004', padding: 24, marginBottom: 24 }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', background: 'var(--background-secondary)', borderRadius: 10, overflow: 'hidden', fontSize: 15 }}>
          <thead>
            <tr style={{ background: '#353848', color: '#aaa' }}>
        ...
        {showNotificationModal && (
          <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: '#0008', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center' }} role="dialog" aria-modal="true">
            <div style={{ background: 'var(--background-secondary, #222535)', color: 'var(--text-primary, #f9fafb)', borderRadius: 14, padding: 32, minWidth: 400, maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 8px 40px #0008', position: 'relative' }}>
              ...
              <form onSubmit={e => { e.preventDefault(); saveNotification(editingNotification ? editingNotification : { name: '', channel: 'email', message: '', status: 'enabled', created: new Date().toISOString().slice(0, 10) }); }}>
                ...
                <div style={{ background: 'var(--background-tertiary, #353848)', borderRadius: 8, padding: 12, marginBottom: 16, color: 'var(--text-primary, #f9fafb)' }}>
                  ...
                  <div style={{ fontFamily: 'monospace', fontSize: 15, whiteSpace: 'pre-wrap', background: 'var(--background-secondary, #222535)', borderRadius: 6, padding: 10, minHeight: 40, color: 'var(--text-primary, #f9fafb)', border: '1px solid #333' }}>{editingNotification ? editingNotification.message : ''}</div>
...
function SegmentStatistics({ segments }) {
  ...
  return (
    <div style={{ display: 'flex', gap: 24, margin: '18px 0' }}>
      <div style={{ background: '#353848', border: '1px solid #353848', borderRadius: 10, padding: 18, minWidth: 140 }}>
...
function ComplianceSection() {
  ...
  return (
    <div>
      ...
      {showAudit && (
        <div style={{ background: '#1a1c25', borderRadius: 10, padding: 18, marginTop: 18, maxHeight: 320, overflowY: 'auto' }}>
          ...
          <table style={{ width: '100%', color: '#fff', fontSize: 15 }}>
            ...
            <tbody>
              {auditLog.length === 0 ? (
                ...
                <tr key={i} style={{ borderTop: '1px solid #353848' }}>
                  <td>{log.timestamp || '-'}</td>
                  <td>{log.user || '-'}</td>
                  <td>{log.action || '-'}</td>
                  <td>{log.type || '-'}</td>
...
function AbandonedCheckoutWinback() {
          ...
          return (
            <section aria-label="A/B Testing">
              ...
              <div style={{ background: '#222535', color: '#f9fafb', borderRadius: 14, boxShadow: '0 2px 8px #0004', padding: 24, marginBottom: 24 }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', background: '#353848', borderRadius: 10, overflow: 'hidden', fontSize: 15 }}>
                  <thead>
                  ...
                  <tbody>
                    {experimentsList.length === 0 ? (
                      ...
                      <tr key={exp.id} style={{ background: exp.selected ? '#1a1c25' : undefined }}>
                        ...
                        <td>
                          <button onClick={() => openExperimentModal(exp)} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '4px 12px', fontWeight: 500, fontSize: 14, cursor: 'pointer', marginRight: 6 }}>Edit</button>
                          <button onClick={() => setExperimentsList(list => list.filter(x => x.id !== exp.id))} style={{ background: '#353848', color: '#ef4444', border: '1px solid #353848', borderRadius: 6, padding: '4px 12px', fontWeight: 500, fontSize: 14, cursor: 'pointer' }}>Delete</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
                ...
                {showExperimentModal && (
                  <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: '#0008', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center' }} role="dialog" aria-modal="true">
                    <div style={{ background: '#353848', color: '#f9fafb', borderRadius: 14, padding: 32, minWidth: 400, boxShadow: '0 8px 40px #0008', position: 'relative' }}>
                      ...
                      <form onSubmit={e => { e.preventDefault(); saveExperiment(editingExperiment ? editingExperiment : { name: '', segment: '', variantA: '', variantB: '', status: 'draft', created: new Date().toISOString().slice(0, 10), results: null }); }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 12 }}>
                          <button type="button" onClick={closeExperimentModal} style={{ background: '#353848', color: '#f9fafb', border: 'none', borderRadius: 8, padding: '7px 18px', fontWeight: 600, fontSize: 15, cursor: 'pointer' }}>Cancel</button>
      ...
      return (
        <div style={{ marginTop: 24 }}>
          ...
          {loading ? <div>Loading...</div> : (
            <table style={{ width: '100%', color: '#fff', fontSize: 15, background: '#1a1c25', borderRadius: 10 }}>
              <thead>
                <tr style={{ color: '#aaa', textAlign: 'left' }}>
                  <th>Trigger</th>
                  <th>Action</th>
    ...
    function IntegrationsSection() {
      ...
      return (
        <div style={{ marginTop: 24 }}>
            ...
            <table style={{ width: '100%', color: '#fff', fontSize: 15, background: '#1a1c25', borderRadius: 10 }}>
              ...
              <tbody>
                {filtered.map(integration => (
                  <tr key={integration.id} style={{ borderTop: '1px solid #353848' }}>
          ...
          {showAddModal && (
            <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: '#0008', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center' }} role="dialog" aria-modal="true">
              <div style={{ background: '#1a1c25', borderRadius: 14, padding: 32, minWidth: 340, boxShadow: '0 8px 40px #0008', position: 'relative', color: '#f9fafb' }}>
    ...
    return (
      <div style={{ minHeight: '100vh', background: '#1a1c25', width: '100%' }}>
        {/* Top Tab Navigation */}
        <nav aria-label="Winback flagship navigation" style={{
          ...
          {flagshipSections.map(section => (
            <button
              ...
              style={{
                background: activeSection === section.key ? '#353848' : 'none',
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ marginTop: 10, display: 'flex', gap: 12, alignItems: 'center' }}>
                  <input
                    ...
                    style={{ flex: 1, padding: 10, borderRadius: 8, border: '1px solid #333', fontSize: 15, background: '#1a1c25', color: '#f9fafb' }}
                  />
                  <button
                    onClick={async () => {
                ...
                {aiSegmentResult && (
                  <div style={{ marginTop: 16, background: '#1a1c25', borderRadius: 8, padding: 14, color: '#a7f3d0' }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
                  {[
                    ...
                    <button
                      ...
                      style={{ background: '#1a1c25', color: '#fff', border: '1px solid #333', borderRadius: 8, padding: '10px 18px', fontWeight: 600, fontSize: 15, cursor: 'pointer', minWidth: 180, textAlign: 'left' }}
              ...
              <div style={{ marginTop: 24, marginBottom: 32 }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 15 }}>
                  <thead>
                    <tr style={{ background: '#1a1c25' }}>
                      <th style={{ fontWeight: 600, fontSize: 14, color: '#a8adc4', padding: '12px 8px', borderBottom: '1px solid #353848' }}><input type="checkbox" checked={segmentsList.every(s => s.selected)} onChange={e => selectAllSegments(e.target.checked)} aria-label="Select all segments" /></th>
                      <th style={{ fontWeight: 600, fontSize: 14, color: '#a8adc4', padding: '12px 8px', borderBottom: '1px solid #353848' }}>Name</th>
                      <th style={{ fontWeight: 600, fontSize: 14, color: '#a8adc4', padding: '12px 8px', borderBottom: '1px solid #353848' }}>Rule</th>
                      <th style={{ fontWeight: 600, fontSize: 14, color: '#a8adc4', padding: '12px 8px', borderBottom: '1px solid #353848' }}>Created</th>
                      <th style={{ fontWeight: 600, fontSize: 14, color: '#a8adc4', padding: '12px 8px', borderBottom: '1px solid #353848' }}>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {segmentsList.length === 0 ? (
                      <tr><td colSpan={5} style={{ textAlign: 'center', color: '#64748b', padding: 24 }}>No segments yet.</td></tr>
                        ...
                        .map(s => (
                          <tr key={s.id} style={{ borderBottom: '1px solid #353848' }}>
                            ...
                            <td style={{ verticalAlign: 'top', padding: '12px 8px', minWidth: 320 }}>
                              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, marginBottom: 8 }}>
                                <button onClick={() => openSegmentModal(s)} style={{ background: '#1a1c25', color: '#f9fafb', border: '1px solid #353848', borderRadius: 6, padding: '4px 12px', fontWeight: 500, fontSize: 14, cursor: 'pointer' }}>Edit</button>
                                <button onClick={() => setSegmentsList(list => list.filter(x => x.id !== s.id))} style={{ background: '#353848', color: '#ef4444', border: '1px solid #353848', borderRadius: 6, padding: '4px 12px', fontWeight: 500, fontSize: 14, cursor: 'pointer' }}>Delete</button>
                              ...
                              <div style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px solid #353848' }}>
                                <SegmentAutomations segment={s} onUpdate={automation => handleUpdateAutomation(s.id, automation)} />
                              </div>
                              <div style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px solid #353848', display: 'flex', flexWrap: 'wrap', gap: 10 }}>
              ...
              {showSegmentModal && (
                <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: '#0008', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center' }} role="dialog" aria-modal="true">
                  <div style={{ background: '#1a1c25', borderRadius: 14, padding: 32, minWidth: 400, boxShadow: '0 8px 40px #0008', position: 'relative', color: '#f9fafb' }}>
        ...
        {activeSection === 'analytics' && (
          <section aria-label="Analytics">
            ...
            <div style={{ display: 'flex', gap: 24, margin: '24px 0' }}>
              <div style={{ background: '#353848', borderRadius: 10, padding: 18, minWidth: 180 }}>
            ...
            {/* Analytics Table */}
            <div style={{ background: '#1a1c25', borderRadius: 10, padding: 18, marginTop: 18 }}>
              <table style={{ width: '100%', color: '#fff', fontSize: 15 }}>
                <thead>
                  <tr style={{ color: '#aaa', textAlign: 'left' }}>
                    <th>Date</th>
        ...
        {activeSection === 'activityLog' && (
          <section aria-label="Activity Log">
            <div style={{ background: '#222535', color: '#f9fafb', borderRadius: 14, boxShadow: '0 2px 8px #0004', padding: 32, marginBottom: 24, marginTop: 18 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 18 }}>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    <div style={{ position: 'absolute', top: 36, right: 0, background: '#222535', color: '#f9fafb', borderRadius: 8, boxShadow: '0 2px 8px #0008', padding: 12, zIndex: 10 }}>
              ...
              <input type="text" placeholder="Search actions, users, details..." value={activityLogSearch} onChange={e => setActivityLogSearch(e.target.value)} style={{ width: '100%', marginBottom: 18, padding: 10, borderRadius: 8, border: '1px solid #333', background: '#222535', color: '#f9fafb', fontSize: 15 }} />
              <div style={{ display: 'flex', gap: 12, marginBottom: 18 }}>
                <input type="text" placeholder="Filter by user" value={activityLogFilters.user} onChange={e => setActivityLogFilters(f => ({ ...f, user: e.target.value }))} style={{ flex: 1, padding: 8, borderRadius: 8, border: '1px solid #333', background: '#222535', color: '#f9fafb', fontSize: 14 }} />
                <input type="text" placeholder="Filter by action" value={activityLogFilters.action} onChange={e => setActivityLogFilters(f => ({ ...f, action: e.target.value }))} style={{ flex: 1, padding: 8, borderRadius: 8, border: '1px solid #333', background: '#222535', color: '#f9fafb', fontSize: 14 }} />
                <input type="text" placeholder="Filter by type" value={activityLogFilters.type} onChange={e => setActivityLogFilters(f => ({ ...f, type: e.target.value }))} style={{ flex: 1, padding: 8, borderRadius: 8, border: '1px solid #333', background: '#222535', color: '#f9fafb', fontSize: 14 }} />
                <input type="text" placeholder="Filter by campaign" value={activityLogFilters.campaignId} onChange={e => setActivityLogFilters(f => ({ ...f, campaignId: e.target.value }))} style={{ flex: 1, padding: 8, borderRadius: 8, border: '1px solid #333', background: '#222535', color: '#f9fafb', fontSize: 14 }} />
              </div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', background: 'var(--background-secondary)', borderRadius: 10, overflow: 'hidden', fontSize: 15 }}>
                  ...
                  <tbody>
                    {filteredActivityLog.map(log => (
                      <tr key={log.id} style={{ borderBottom: '1px solid #353848' }}>
                        {activityLogColumns.filter(c => c.visible).map(col => (
              ...
              {showLogDetails && logDetails && (
                <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: '#0008', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center' }} role="dialog" aria-modal="true">
                  <div style={{ background: 'var(--background-secondary, #222535)', color: 'var(--text-primary, #f9fafb)', borderRadius: 14, padding: 32, minWidth: 400, maxHeight: '90vh', overflowY: 'auto' }}>
                    <h3 style={{ fontWeight: 800, fontSize: 22, marginBottom: 18 }}>Log Entry Details</h3>
                    <pre style={{ background: '#222535', color: '#f9fafb', borderRadius: 8, padding: 16, fontSize: 15, maxHeight: 400, overflow: 'auto' }}>{JSON.stringify(logDetails, null, 2)}</pre>
          ...
          <section aria-label="Help & Docs">
            ...
            <div style={{ margin: '32px 0', background: '#f9fafb', borderRadius: 14, boxShadow: '0 2px 8px #0001', padding: 32 }}>
              ...
              <div style={{ marginTop: 32 }}>
                ...
                <ul style={{ fontSize: 15, color: '#454860', paddingLeft: 24 }}>
...
function CustomSegmentBuilder({ onCreate }) {
  ...
  return (
    <div style={{ background: '#1a1c25', borderRadius: 8, padding: 16, marginTop: 8 }}>
      <div style={{ display: 'flex', gap: 12, marginBottom: 10 }}>
        <input value={name} onChange={e => setName(e.target.value)} placeholder="Segment name" style={{ flex: 2, padding: 8, borderRadius: 6, border: '1px solid #333', fontSize: 15, background: '#353848', color: '#f9fafb' }} />
      </div>
      {rules.map((r, idx) => (
        <div key={idx} style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 8 }}>
          <select value={r.field} onChange={e => handleRuleChange(idx, 'field', e.target.value)} style={{ padding: 6, borderRadius: 6, border: '1px solid #333', fontSize: 15, background: '#353848', color: '#f9fafb' }}>
            {fields.map(f => <option key={f.value} value={f.value}>{f.label}</option>)}
          </select>
          <select value={r.op} onChange={e => handleRuleChange(idx, 'op', e.target.value)} style={{ padding: 6, borderRadius: 6, border: '1px solid #333', fontSize: 15, background: '#353848', color: '#f9fafb' }}>
            {ops.map(o => <option key={o.value} value={o.value}>{o.label}</option>)}
          </select>
          <input value={r.value} onChange={e => handleRuleChange(idx, 'value', e.target.value)} placeholder="Value" style={{ flex: 1, padding: 6, borderRadius: 6, border: '1px solid #333', fontSize: 15, background: '#353848', color: '#f9fafb' }} />
      ...
      <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
        {automations.length === 0 ? (
          ...
          automations.map((a, idx) => (
            <span key={idx} style={{ background: '#353848', color: '#fff', borderRadius: 6, padding: '2px 10px', fontSize: 13, fontWeight: 600, marginRight: 4 }}>{a.type}</span>
          ))
        )}
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: '#0008', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center' }} role="dialog" aria-modal="true">
          <div style={{ background: '#1a1c25', borderRadius: 14, padding: 32, minWidth: 340, boxShadow: '0 8px 40px #0008', position: 'relative', color: '#f9fafb' }}>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <select id="automation-type" style={{ width: '100%', padding: 8, borderRadius: 6, border: '1px solid #333', fontSize: 15, background: '#353848', color: '#f9fafb', marginBottom: 12 }}>
                <option value="email">Send Email</option>
                <option value="sms">Send SMS</option>
                <option value="push">Send Push</option>
                <option value="webhook">Trigger Webhook</option>
              </select>
              <input id="automation-detail" placeholder="Details (e.g. template, URL)" style={{ width: '100%', padding: 8, borderRadius: 6, border: '1px solid #333', fontSize: 15, background: '#353848', color: '#f9fafb', marginBottom: 12 }} />
              <button onClick={() => {
            ...
            <div style={{ marginTop: 18 }}>
              ...
              {automations.length === 0 ? (
                ...
                automations.map((a, idx) => (
                  <div key={idx} style={{ background: '#353848', color: '#fff', borderRadius: 6, padding: '6px 10px', fontSize: 14, fontWeight: 600, marginBottom: 6 }}>
                    {a.type}: {a.detail}
                  </div>
                ))
              )}
    ...
    <div style={{ marginTop: 8, display: 'flex', gap: 8, alignItems: 'center' }}>
      ...
      {allChannels.map(ch => (
        <button
          ...
          style={{
            background: channels.includes(ch.key) ? ch.color : '#353848',
  ...
  return (
    <div style={{ marginTop: 8, display: 'flex', gap: 6, alignItems: 'center' }}>
      ...
      <button
        ...
        style={{
          background: mode === 'include' ? '#22c55e' : '#353848',
      ...
      <button
        ...
        style={{
          background: mode === 'exclude' ? '#ef4444' : '#353848',
...
function StoreLanguageSelector({ segment, onUpdate }) {
  ...
  return (
    <div style={{ marginTop: 8, display: 'flex', gap: 10, alignItems: 'center' }}>
      ...
      <select value={store} onChange={e => handleChange('store', e.target.value)} style={{ padding: 6, borderRadius: 6, border: '1px solid #333', fontSize: 13, background: '#353848', color: '#f9fafb' }}>
        {stores.map(s => <option key={s} value={s}>{s}</option>)}
      </select>
      <span style={{ fontSize: 13, color: '#a8adc4', fontWeight: 600 }}>Language:</span>
      <select value={language} onChange={e => handleChange('language', e.target.value)} style={{ padding: 6, borderRadius: 6, border: '1px solid #333', fontSize: 13, background: '#353848', color: '#f9fafb' }}>
