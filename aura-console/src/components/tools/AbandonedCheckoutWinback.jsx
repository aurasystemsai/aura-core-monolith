      ...
      {categories.map(cat => (
        <button
          ...
          style={{
            ...
            color: '#fafafa',
            border: activeCategory === cat.id ? '2px solid #6366f1' : '1px solid #3f3f46',
            borderRadius: 8,
            padding: '10px 20px',
            fontWeight: 700,
            fontSize: 15,
        ...
        {currentTabs.map(tab => (
          <button
            ...
            style={{
              ...
              border: activeTab === tab.id ? '2px solid #6366f1' : '1px solid #3f3f46',
              borderRadius: 6,
              padding: '8px 16px',
              fontWeight: 600,
              fontSize: 14,
...
function AlertsTab() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gap: 12 }}>
        {alerts.length === 0 ? (
          <div style={{ background: '#3f3f46', padding: 32, borderRadius: 10, textAlign: 'center', color: '#64748b' }}>No active alerts</div>
        ) : alerts.map((alert, idx) => (
          <div key={idx} style={{ background: '#3f3f46', padding: 18, borderRadius: 10, borderLeft: `4px solid ${alert.severity === 'critical' ? '#ef4444' : alert.severity === 'warning' ? '#f59e0b' : '#6366f1'}` }}>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gap: 18 }}>
        {brands.length === 0 ? (
          <div style={{ background: '#3f3f46', padding: 32, borderRadius: 10, textAlign: 'center', color: '#64748b' }}>No brands configured</div>
...
function LocalizationTab() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gap: 12 }}>
        {locales.length === 0 ? (
          <div style={{ background: '#3f3f46', padding: 32, borderRadius: 10, textAlign: 'center', color: '#64748b' }}>No locales configured. Add your first language!</div>
...
function CollaborationTab() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gap: 12 }}>
        {comments.length === 0 ? (
          <div style={{ background: '#3f3f46', padding: 32, borderRadius: 10, textAlign: 'center', color: '#64748b' }}>No comments yet</div>
      ...
      {stages.map(stage => (
        <button
          ...
          style={{
            ...
            color: '#fafafa',
            border: selectedStage === stage.key ? '2px solid #6366f1' : '1px solid #3f3f46',
            borderRadius: 8,
            padding: '10px 18px',
            fontWeight: 600,
            fontSize: 15,
