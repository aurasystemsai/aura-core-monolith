  ...
  return (
    <div style={{ background: "#09090b", color: "#f3f4f6", borderRadius: 18, boxShadow: "0 2px 24px #0002", padding: 36, fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 18 }}>
        <button onClick={handleScore} disabled={loading || !content} style={{ background: "#818cf8", color: "#09090b", border: "none", borderRadius: 8, padding: "10px 22px", fontWeight: 700, fontSize: 16, cursor: "pointer" }}>{loading ? "Scoring..." : "AI Score"}</button>
      ...
      {response && (
        <div style={{ background: "#27272a", borderRadius: 10, padding: 16, marginBottom: 12, border: "1px solid #27272a" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
            <span style={{ fontWeight: 700, color: "#818cf8", fontSize: 14 }}>AI Score Report</span>
