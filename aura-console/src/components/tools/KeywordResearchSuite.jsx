...
export default function KeywordResearchSuite() {
  ...
  return (
    <div style={{
      ...
      />
      <button onClick={handleAnalyze} disabled={loading || !query} style={{ background: "#a3e635", color: "#0a0b0f", border: "none", borderRadius: 8, padding: "10px 22px", fontWeight: 700, fontSize: 16, cursor: "pointer", marginBottom: 18 }}>{loading ? "Analyzing..." : "Analyze"}</button>
