    ...
    <div>
      <div style={S.card}>
        ...
        <div style={S.inputRow}>
          ...
          <input style={{ ...S.input, flex: "0 1 220px" }} placeholder="Your domain (optional)"
            value={trackDomain} onChange={(e) => setTrackDomain(e.target.value)} onKeyDown={(e) => e.key === "Enter" && track()} />
