...
export default function AILaunchPlanner() {
  ...
  return (
    <div style={{ maxWidth: 700, margin: "40px auto", background: "#fff", borderRadius: 16, boxShadow: "0 2px 16px #0001", padding: 32 }}>
      <h2 style={{ fontWeight: 700, fontSize: 28, marginBottom: 12 }}>AI Launch Planner</h2>
      ...
      <div style={{ marginTop: 24, marginBottom: 24 }}>
        ...
        {exported && <a href={exported} download="ai-launch-planner-history.json" style={{ marginLeft: 12, color: '#22c55e', textDecoration: 'underline' }}>Download Export</a>}
      </div>
