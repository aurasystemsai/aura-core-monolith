...
const TABS = [
 ...
 { id: "youtube", label: "YouTube Copy"},
 { id: "landing", label: "Landing Pages"},
 { id: "utilities", label: "Utilities"},
 { id: "ecom", label: "E-com Specials"},
...
function BrandVoiceTab() {
 ...
 {loading ? <><Spinner />Analyzing...</> : "Build Style Profile"}
 </button>
...
function BlogTab() {
 ...
 {loading ? <><Spinner />Writing... (30-60s)</> : "Generate Blog Post"}
 </button>
 </>}
 ...
 {loading ? <><Spinner />Repurposing...</> : "Repurpose Content"}
 </button>
 </>}
 </div>
