...
export default function AuraAPISDK() {
  ...
  return (
    <div className="tool-main-flex" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      {response && (
        <div style={{ background: "#3c3c3c", borderRadius: 10, padding: 18, marginBottom: 18, color: "#f0f0f0" }}>
          <b>Response:</b>
          <pre style={{ fontSize: 15 }}>{JSON.stringify(response, null, 2)}</pre>
        </div>
      )}
      {docs.length > 0 && (
        <div style={{ background: "#3c3c3c", borderRadius: 12, padding: 20, marginBottom: 18, color: "#f0f0f0" }}>
          <b>API Docs:</b>
