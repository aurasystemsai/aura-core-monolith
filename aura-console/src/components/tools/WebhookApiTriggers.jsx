      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 12, marginBottom: 16 }}>
        ...
        <div style={{ background: '#18181b', borderRadius: 12, padding: 14, border: '1px solid #27272a' }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            ...
            <button onClick={handleUpdateApi} style={{ background: '#6366f1', color: '#fafafa', border: 'none', borderRadius: 10, padding: '8px 14px', fontWeight: 800, cursor: 'pointer' }}>Update Selected</button>
                  ...
                  {showPreflightPopover && (
                    <div style={{ position: 'absolute', top: '110%', right: 0, minWidth: 220, background: '#18181b', border: '1px solid #27272a', borderRadius: 10, padding: 10, boxShadow: '0 10px 30px rgba(0,0,0,0.4)', zIndex: 10 }}>
                      ...
                      <div style={{ marginTop: 8, display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                        ...
                        <button onClick={() => applyQuickFix('dedupe-labels')} style={{ background: '#6366f1', color: '#fafafa', border: 'none', borderRadius: 8, padding: '6px 10px', fontWeight: 800, cursor: 'pointer' }}>Clean IPs</button>
                      </div>
