        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ background: "#18181b", border: "1px solid #27272a", borderRadius: 14, padding: 14 }}>
            ...
            <form onSubmit={e => { e.preventDefault(); handleFeedback(); }} aria-label="Send feedback">
              ...
              />
              <button type="submit" style={{ background: "#818cf8", color: "#18181b", border: "none", borderRadius: 10, padding: "10px 14px", fontWeight: 800, cursor: "pointer" }}>Send Feedback</button>
            </form>
          </div>
