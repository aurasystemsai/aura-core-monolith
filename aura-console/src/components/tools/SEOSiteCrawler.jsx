...
function SeverityBadge({ sev }) {
  return (
    <span style={{
      background: SEV_BG[sev] || "#222535",
      color: SEV_COLORS[sev] || "#94a3b8",
      border: `1px solid ${SEV_COLORS[sev] || "#454860"}`,
...
function IssueCard({ issue, pageUrl }) {
  ...
  return (
    <div style={{ background: SEV_BG[issue.severity] || "#222535", borderRadius: 8, padding: "10px 14px", border: `1px solid ${SEV_COLORS[issue.severity] || "#454860"}22`, marginBottom: 8 }}>
      ...
      {suggestion && (
        <div style={{ marginTop: 8, background: "#222535", borderRadius: 6, padding: "8px 12px", border: "1px solid #222535", fontSize: 13, color: "#6366f1", whiteSpace: "pre-wrap", lineHeight: 1.6 }}>
          {suggestion}
          <button onClick={() => navigator.clipboard?.writeText(suggestion)} style={{ display: "block", marginTop: 6, background: "transparent", border: "1px solid #454860", borderRadius: 5, padding: "2px 10px", color: "#64748b", fontSize: 11, cursor: "pointer" }}>Copy</button>
        </div>
      )}
...
function KeywordPresencePanel({ keywords, keywordPresence }) {
  ...
  return (
    <div style={{ background: "#1a1c25", borderRadius: 8, padding: "10px 14px", marginBottom: 10, border: "1px solid #222535" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
        {(keywordPresence || []).map(kp => (
          <div key={kp.keyword} style={{ background: "#0d0d11", borderRadius: 8, padding: "6px 12px", border: "1px solid #222535", fontSize: 13 }}>
...
function PageSection({ page, keywords }) {
  ...
  return (
    <div style={{ background: "#0d0d11", borderRadius: 10, border: "1px solid #222535", marginBottom: 12 }}>
      <button
        onClick={() => setOpen(o => !o)}
    ...
    <div style={{ background: "#0d0d11", color: "#f3f4f6", borderRadius: 18, boxShadow: "0 2px 24px #0002", padding: 36, fontFamily: "Inter, sans-serif" }}>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <input
          ...
          style={{ width: "100%", fontSize: 15, padding: "10px 14px", borderRadius: 8, border: "1px solid #454860", background: "#222535", color: "#f3f4f6", boxSizing: "border-box" }}
      ...
      <div style={{ marginBottom: 18 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 6, background: "#222535", borderRadius: 8, border: "1px solid #454860", padding: "8px 10px", minHeight: 44, alignItems: "center" }}>
          {keywords.map(kw => (
            <span key={kw} style={{ background: "#222535", color: "#6366f1", borderRadius: 20, padding: "3px 11px 3px 12px", fontSize: 13, fontWeight: 600, display: "flex", alignItems: "center", gap: 6 }}>
              {kw}
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 20, flexWrap: "wrap" }}>
        <button onClick={handleCrawl} disabled={loading || !input.trim()} style={{ background: loading ? "#454860" : "#6366f1", color: "#0d0d11", border: "none", borderRadius: 8, padding: "11px 26px", fontWeight: 700, fontSize: 15, cursor: loading || !input.trim() ? "not-allowed" : "pointer" }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 16 }}>
            {[
              ...
              <div key={s.label} style={{ background: "#222535", borderRadius: 10, padding: "10px 18px", border: "1px solid #222535", textAlign: "center" }}>
      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 20 }}>
        <div style={{ background: "#222535", borderRadius: 10, padding: "10px 18px", border: "1px solid #222535" }}>
      ...
      {/* History */}
      {history.length > 0 && (
        <div style={{ background: "#1a1c25", borderRadius: 12, padding: 18 }}>
