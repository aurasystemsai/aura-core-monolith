...
export default function ToolScaffold({ toolId, toolName, fields }) {
 ...
 {showHelp && (
 <div style={{ background: darkMode ? "#09090b": "#f4f4f5", borderRadius: 10, padding: 16, marginBottom: 16 }}>
 <div style={{ fontWeight: 700, marginBottom: 8 }}>How to use {toolName}</div>
 <ul style={{ margin: 0, paddingLeft: 18, color: darkMode ? "#a3e635": "#52525b", fontSize: 15 }}>
 ...
 <button type="submit"disabled={loading} style={{ marginTop: 12, background: "#4f46e5", color: "#09090b", border: "none", borderRadius: 8, padding: "12px 32px", fontWeight: 700, fontSize: 17, cursor: loading ? "not-allowed": "pointer", boxShadow: "0 2px 12px #22d3ee55"}}>
 ...
 <h3>Result</h3>
 <pre style={{ background: darkMode ? "#09090b": "#222", color: darkMode ? "#a3e635": "#4f46e5", padding: 12, borderRadius: 6, overflowX: "auto"}}>
