...
export default function AdvancedAnalyticsAttribution() {
  ...
  const onboardingContent = (
    <div style={{ background: "var(--bg-alt)", borderRadius: "var(--radius-md)", padding: 16, marginBottom: 18, color: "var(--text)" }}>
  ...
  return (
    <div className="tools-panel" style={{ maxWidth: 1100, margin: "40px auto", background: "var(--card)", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-soft)", border: "1px solid var(--border)", padding: 32 }}>
      ...
      {result && (
        <div style={{ background: "var(--bg-alt)", borderRadius: "var(--radius-md)", padding: 16, marginBottom: 12, color: "var(--text)" }}>
