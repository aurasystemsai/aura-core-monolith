  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ display: "grid", gap: 8, background: "#0b1221", border: "1px solid #1a1a1a", borderRadius: 12, padding: 12 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
            ...
            {maintenance.locked && (
              <span style={{ background: "#3b1d1d", color: "#f87171", padding: "6px 10px", borderRadius: 10, fontSize: 12, border: "1px solid #1a1a1a" }}>
        ...
        <div style={{ display: "grid", gap: 6 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
            ...
            <label style={{ display: "flex", alignItems: "center", gap: 6, color: "#888888", fontSize: 12 }}>
      ...
      <div style={{ display: "grid", gap: 8 }}>
        ...
        {validation && (
          <div style={{ marginTop: 6, background: validation.status === "ok" ? "#111111" : "#1a1a1a", border: "1px solid #1a1a1a", borderRadius: 10, padding: 10, display: "grid", gap: 6 }}>
            ...
            {validation.stats && (
              <div style={{ color: "#888888", fontSize: 13 }}>Orders {validation.stats.orders} · Ads {validation.stats.ads} · Offline {validation.stats.offline}</div>
            )}
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", color: "#888888", fontSize: 13 }}>
          <div style={{ background: "#111111", border: "1px solid #1a1a1a", borderRadius: 10, padding: 10, minWidth: 200 }}>
      ...
      <div style={{ display: "grid", gap: 10, background: "#0b1221", border: "1px solid #1a1a1a", borderRadius: 12, padding: 12 }}>
        ...
        {integrationTests.length > 0 && (
          <div style={{ color: "#888888", fontSize: 12 }}>Tests: {integrationTests.map(t => `${t.name}:${t.status}`).join(" · ")}</div>
        )}
      </div>
          ...
          {layoutPanels.map((p, idx) => (
            <div key={p} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "#111827", border: "1px solid #1a1a1a", borderRadius: 10, padding: "8px 10px" }}>
              ...
              <div style={{ display: "flex", gap: 6 }}>
                ...
                <button onClick={() => movePanel(idx, 1)} disabled={idx === layoutPanels.length - 1} style={{ background: "#1a1a1a", color: "#f0f0f0", border: "1px solid #333333", borderRadius: 8, padding: "4px 8px", fontWeight: 700, cursor: idx === layoutPanels.length - 1 ? "not-allowed" : "pointer", opacity: idx === layoutPanels.length - 1 ? 0.5 : 1 }}>↓</button>
              </div>
            </div>
          ))}
        </div>
            ...
            {history.slice(0, 3).map((h, idx) => (
              <div key={idx} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, flexWrap: "wrap", background: "#111827", border: "1px solid #1a1a1a", borderRadius: 10, padding: "8px 10px" }}>
                <div>
                  ...
                  {h.metrics && (
                    <div style={{ color: "#888888", fontSize: 12 }}>ROAS {h.metrics.roas ?? "-"} · CAC {h.metrics.cac ?? "-"} · Spend {h.metrics.spend ?? "-"}</div>
                  )}
                </div>
      ...
      {result && (
        <div style={{ display: "grid", gap: 12, background: "#0d1420", border: "1px solid #24314a", borderRadius: 10, padding: 16 }}>
          ...
          {shareToken && (
            <div style={{ color: "#888888", fontSize: 12 }}>Share link: {`${window.location.origin}/share/${shareToken}`}</div>
          )}
        </div>
      )}
          ...
          <div style={{ display: "grid", gap: 6 }}>
            {auditLog.slice(0, 8).map((entry, idx) => (
              <div key={idx} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap", background: "#111827", border: "1px solid #1a1a1a", borderRadius: 10, padding: "6px 10px" }}>
                ...
                <div style={{ color: "#888888", fontSize: 12 }}>{entry.meta ? JSON.stringify(entry.meta) : ""}</div>
              </div>
            ))}
          </div>
        </div>
