        ...
        <div>
          ...
          {result.longTermStrategy && (
            <div style={{ ...S.card, borderColor: "#4c1d95" }}>
              <p style={S.sectionTitle}>🗺️ Long-Term Strategy</p>
...
function PromptCoverageTab() {
  ...
  return (
    <div>
      <div style={S.card}>
        <p style={S.sectionTitle}>🗺️ Prompt Coverage Mapping</p>
          ...
          <div style={{ ...S.row, alignItems: "center", marginBottom: "16px" }}>
            ...
            <div>
              <div style={{ fontSize: "14px", fontWeight: 700, color: result.score >= 80 ? "#22c55e" : "#ef4444" }}>
                {result.blockedCount === 0 ? "All AI Crawlers Allowed ✅" : `${result.blockedCount} Crawler(s) Blocked ⚠️`}
              </div>
