...
export default function BlogSEO() {
  ...
  const handleFeedback = async () => {
    ...
    setError("");
    try {
      await fetch("/api/blog-seo/feedback", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  return (
    <div style={{ background: "#18181b", borderRadius: 16, boxShadow: "0 2px 16px #0008", padding: 32, color: '#e5e7eb' }}>
      ...
      <div style={{ marginTop: 24, marginBottom: 24 }}>
        ...
        {exported && <a href={exported} download="blog-seo-history.json" style={{ marginLeft: 12, color: '#22c55e', textDecoration: 'underline' }}>Download Export</a>}
      </div>
