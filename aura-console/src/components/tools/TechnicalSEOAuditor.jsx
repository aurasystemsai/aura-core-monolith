  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        rows={3}
        style={{ width: "100%", fontSize: 16, padding: 12, borderRadius: 8, border: "1px solid #555", marginBottom: 18, background: "#0d0d11", color: "#f3f4f6" }}
      ...
      <form
        ...
        style={{ marginTop: 32, background: darkMode ? "#0d0d11" : "#f8fafc", borderRadius: 12, padding: 20 }}
      ...
      >
        ...
        <textarea
          ...
          rows={2}
          style={{ width: "100%", fontSize: 15, padding: 10, borderRadius: 8, border: darkMode ? "1px solid #555" : "1px solid #ccc", marginBottom: 12, background: darkMode ? "#0d0d11" : "#fff", color: darkMode ? "#f3f4f6" : "#0d0d11" }}
