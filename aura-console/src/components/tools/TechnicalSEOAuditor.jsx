...
export default function TechnicalSEOAuditor() {
  ...
  const handleRun = async () => {
    ...
    setNotification("");
    try {
      setNotification("Auditing in progress...");
      const res = await fetch("/api/technical-seo-auditor/ai/audit", {
        method: "POST",
      ...
      setNotification("Audit report generated and saved.");
      setHistory(prev => [{
        site: input,
        bulkUpload,
        channels,
        ...
        compliance,
        education,
        auditReport: data.auditReport || "No report generated",
