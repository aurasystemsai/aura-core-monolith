  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        rows={3}
        style={{ width: "100%", fontSize: 16, padding: 12, borderRadius: 8, border: "1px solid #555", marginBottom: 18, background: "#0a0b0f", color: "#f3f4f6" }}
      ...
      {analytics && analytics.length > 0 && (
        <div style={{ marginTop: 24, background: "#283044", borderRadius: 12, padding: 18 }}>
          <div style={{ fontWeight: 600, fontSize: 16, marginBottom: 8, color: "#4f46e5" }}>Analytics</div>
          <div style={{ display: "flex", gap: 12 }}>
            <div style={{ background: "#0a0b0f", borderRadius: 8, padding: "12px 20px", border: "1px solid #283044" }}>
      ...
      <form
        ...
        style={{ marginTop: 32, background: darkMode ? "#0a0b0f" : "#f8fafc", borderRadius: 12, padding: 20 }}
      ...
      >
        ...
        <textarea
          ...
          rows={2}
          style={{ width: "100%", fontSize: 15, padding: 10, borderRadius: 8, border: darkMode ? "1px solid #555" : "1px solid #ccc", marginBottom: 12, background: darkMode ? "#0a0b0f" : "#fff", color: darkMode ? "#f3f4f6" : "#0a0b0f" }}
