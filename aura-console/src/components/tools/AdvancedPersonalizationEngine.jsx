    ...
    <div style={{ padding: 16, background: palette.bg, color: palette.text, borderRadius: 12 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <button onClick={saveVersion} style={{ padding: "8px 12px", borderRadius: 10, border: `1px solid ${palette.accent}`, background: palette.accent, color: "#252638", fontWeight: 800, cursor: "pointer" }}>Save Version</button>
      ...
      <div style={{ display: "grid", gap: 12, marginTop: 12 }}>
        {showOnboarding && (
          <div style={{ ...paletteCard, boxShadow: "0 12px 32px rgba(0,0,0,0.22)" }}>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 10, flexWrap: "wrap" }}>
              <button onClick={() => setShowOnboarding(false)} style={{ background: palette.accent, color: "#252638", border: "none", borderRadius: 10, padding: "10px 18px", fontWeight: 800, cursor: "pointer" }}>Start</button>
          ...
          <div style={{ display: "grid", gap: 8 }}>
            {recommendations.map((rec) => (
              <div key={rec.id} style={{ ...paletteCard, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <button onClick={() => promoteRecommendation(rec)} style={{ background: palette.accent, color: "#252638", border: "none", borderRadius: 10, padding: "8px 12px", fontWeight: 800, cursor: "pointer" }}>Promote</button>
              </div>
            ))}
          </div>
        </div>
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleFeedback(); }} style={{ ...paletteCard }} aria-label="Send feedback">
          ...
          <textarea
            ...
            aria-label="Feedback"
          />
          <button type="submit" style={{ background: palette.accent, color: "#252638", border: "none", borderRadius: 10, padding: "10px 18px", fontWeight: 800, cursor: "pointer" }}>Send Feedback</button>
