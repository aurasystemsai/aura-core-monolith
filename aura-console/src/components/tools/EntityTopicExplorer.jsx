      ...
      <div style={{ display: "flex", gap: 18, marginBottom: 18 }}>
        <div style={{ flex: 1 }}>
          ...
          <ul style={{ paddingLeft: 18 }}>
            {entities.map((e, idx) => (
              <li key={e.id || idx} style={{ marginBottom: 8, background: "#3a4560", borderRadius: 8, padding: 8, color: '#f6f7fb' }}>{e.name}</li>
            ))}
          </ul>
        </div>
        <div style={{ flex: 1 }}>
          ...
          <ul style={{ paddingLeft: 18 }}>
            {topics.map((t, idx) => (
              <li key={t.id || idx} style={{ marginBottom: 8, background: "#1f2433", borderRadius: 8, padding: 8, color: '#4f46e5' }}>{t.name}</li>
            ))}
          </ul>
        </div>
        <div style={{ flex: 1 }}>
