        ...
        <div style={{ flex: 1 }}>
          ...
          <ul style={{ paddingLeft: 18 }}>
            {dataSources.map((ds, idx) => (
              <li key={ds.id || idx} style={{ marginBottom: 8, background: "#3c3c3c", borderRadius: 8, padding: 8, color: '#f0f0f0' }}>{ds.name}</li>
            ))}
          </ul>
        </div>
        <div style={{ flex: 1 }}>
          ...
          <ul style={{ paddingLeft: 18 }}>
            {dashboards.map((db, idx) => (
              <li key={db.id || idx} style={{ marginBottom: 8, background: "#18181b", borderRadius: 8, padding: 8, color: '#7fffd4' }}>{db.name}</li>
            ))}
          </ul>
        </div>
        <div style={{ flex: 1 }}>
          ...
          <ul style={{ paddingLeft: 18 }}>
            {analytics.map((a, idx) => (
              <li key={a.id || idx} style={{ marginBottom: 8, background: "#3c3c3c", borderRadius: 8, padding: 8, color: '#f0f0f0' }}>{a.name}</li>
            ))}
          </ul>
        </div>
      </div>
