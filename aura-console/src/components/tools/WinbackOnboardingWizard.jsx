...
export default function WinbackOnboardingWizard({ onComplete }) {
  ...
  const steps = [
    {
      title: 'Welcome',
      content: 'Welcome to the Abandoned Checkout Winback tool! Let’s get you set up to recover more revenue.'
    },
    {
    ...
    {
      title: 'You’re Ready!',
      content: 'You’re all set! Launch your campaign and watch your revenue grow.'
    }
  ];
  return (
    <div>
