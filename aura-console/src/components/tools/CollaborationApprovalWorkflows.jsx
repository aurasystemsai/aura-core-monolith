  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
        ...
        <div style={{ color: "#a8adc4", fontSize: 13 }}>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 18 }}>
        <button onClick={() => fileInputRef.current?.click()} disabled={isViewer} style={{ background: "#fbbf24", color: "#0d0d11", border: "none", borderRadius: 8, padding: "10px 22px", fontWeight: 700, fontSize: 16, cursor: isViewer ? "not-allowed" : "pointer", opacity: isViewer ? 0.7 : 1 }}>Import</button>
      ...
      <form onSubmit={e => { e.preventDefault(); handleFeedback(); }} style={{ marginTop: 32, background: "#3d4058", borderRadius: 12, padding: 20 }} aria-label="Send feedback">
        ...
        <textarea
          ...
          rows={2}
          style={{ width: "100%", fontSize: 15, padding: 10, borderRadius: 8, border: "1px solid #555", marginBottom: 12, background: "#0d0d11", color: "#f3f4f6" }}
      ...
      {/* ...existing code... */}
      {result && (
        <div style={{ marginTop: 24, background: "#0d0d11", borderRadius: 12, padding: 20 }}>
      ...
      {history.length > 0 && (
        <div style={{ marginTop: 24 }}>
          ...
          <ul style={{ paddingLeft: 18 }}>
            {history.map((h, idx) => (
              <li key={idx} style={{ marginBottom: 8, background: "#0d0d11", borderRadius: 8, padding: 8 }}>
