...
export default function BlogDraftEngine() {
 ...
 <input
 type="text"placeholder="Search ideas..."value={searchQuery}
 ...
 <button
 className="bde-icon-btn"disabled={publishingDraftId === (d.id || d.title)}
 onClick={() => publishDraftToShopify(d)}
 title="Publish to Shopify as draft"style={{ background: publishResults[d.id || d.title] === "ok"? "#22c55e": publishResults[d.id || d.title]?.startsWith("error:") ? "#ef4444": "#4f46e5", color: "#fff", borderRadius: 6, padding: "3px 8px", fontSize: 11, border: "none", cursor: "pointer", fontWeight: 700 }}
 >
