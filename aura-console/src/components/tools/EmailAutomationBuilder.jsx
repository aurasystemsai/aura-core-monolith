...
function CampaignsMgmt({ tab }) {
 ...
 const EVENTS = [
 { time:'2 min ago', icon:'', type:'Email Opened', detail:'Summer Sale Campaign Subject: "30% Off Everything"', contact:'alice@example.com'},
 { time:'15 min ago', icon:'', type:'Link Clicked', detail:'Clicked "Shop Now"button in abandoned cart email', contact:'bob@example.com'},
 ...
 { time:'Today 11:30 AM', icon:'', event:'Clicked "Shop Now"in cart reminder'},
 ...
 { time:'Feb 12', icon:'', event:'Viewed product: Blue Denim Jacket'},
 ...
 { id:'at-risk', label:'At-Risk', icon:'', color:'#f59e0b', count:1105, pct:15, desc:'No engagement for 60120 days'},
 ...
 { label:'Prefix Support', value:'Custom prefix', desc:'AURA-, SAVE-, VIP- etc.', icon:''},
...
function AIMgmt({ tab }) {
 ...
 <StatCard label="Optimal Window"value="24 PM"/>
 ...
 {[
 { type:'Send Time', text:'Shift sends to 24 PM local time. Predicted +12% open rate.', impact:'+12%'},
 ...
 { name:'Recently Viewed', desc:'Remind customers of products they browsed', impact:'+9% return visits', status:'active', icon:''},
 ...
 placeholder="Describe your audience... e.g. 'Customers who spent over $200 in the last 90 days and are located in California'"value={nlQuery}
 ...
 <textarea
 style={{ ...S.textarea, minHeight:'80px'}}
 placeholder="e.g. 'Send a flash sale email to customers who haven't bought in 30 days, offer 20% off with urgency'"value={prompt}
 ...
 <div style={S.grid3}>
 {[
 { action:'Change Background', desc:'Swap product backgrounds to match seasonal campaigns', icon:'', example:'"Change to a winter holiday scene"'},
 ...
 { action:'Add Text Overlay', desc:'Add promotional text, badges, or sale tags to product images', icon:'', example:'"Add a 20% OFF badge in the corner"'},
 { action:'Remove Objects', desc:'Clean up images by removing unwanted elements', icon:'', example:'"Remove the shadow and background items"'},
 { action:'Style Transfer', desc:'Apply artistic styles while keeping product recognizable', icon:'', example:'"Make it look like a watercolor painting"'},
...
function WorkflowsMgmt({ tab }) {
 ...
 { name:'Browse Abandon', desc:'Trigger when user views products but doesn\'t buy', steps:2, icon:'', cat:'Revenue'},
 ...
 { name:'Purchase History', desc:'Split by buying patterns', icon:'', conditions:['Has purchased','Order count > 3','AOV > $100'] },
...
function AnalyticsMgmt({ tab }) {
 ...
 <StatCard label="Warm Leads (5079)"value="3,120"sub="Nurture sequence"color="#f59e0b"/>
 ...
 {[
 { range:'010', pct:8, color:'#3f3f46'},
 { range:'1120', pct:12, color:'#3f3f46'},
 { range:'2130', pct:15, color:'#3b82f6'},
 { range:'3140', pct:18, color:'#3b82f6'},
 { range:'4150', pct:14, color:'#f59e0b'},
 { range:'5160', pct:11, color:'#f59e0b'},
 { range:'6170', pct:9, color:'#f59e0b'},
 { range:'7180', pct:6, color:'#22c55e'},
 { range:'8190', pct:4, color:'#ef4444'},
 { range:'91100', pct:3, color:'#ef4444'},
 ].map(b=>(
 ...
 { label:'Seasonal Peak', value:'Cashmere Sweater', stat:'Best in OctDec (4x revenue)', icon:''},
 ].map(i=>(
 ...
 <div style={S.grid3}>
 {[
 { insight:'Move Primary CTA Higher', detail:'38% of clicks happen in the hero zone keep your main CTA above the fold', icon:'', priority:'High'},
 { insight:'Reduce Footer Links', detail:'Only 4% of clicks reach the footer simplify to unsubscribe + essential links', icon:'', priority:'Medium'},
 { insight:'Larger Product Images', detail:'Product cards get 15% of clicks larger images with click zones boost engagement', icon:'', priority:'Medium'},
...
function TestingMgmt({ tab }) {
 ...
 { check:'Semantic HTML', status:'\u2705 Pass', desc:'Proper heading hierarchy (h1h2h3), lists, and table structure', color:'#22c55e'},
...
function SettingsMgmt({ tab }) {
 ...
 { list:'Spam Complaints', count:12, desc:'Contacts who marked emails as spam', icon:'', color:'red'},
...
export default function EmailAutomationBuilder() {
 ...
 <input
 type="text"placeholder="\u{1F50D} Search tools\u2026"value={searchQuery}
