...
export default function DynamicPricingEngine() {
 ...
 <input
 type="text"placeholder="Strategy Name"value={strategyForm.name}
 ...
 <input
 type="number"placeholder="Target Margin %"value={strategyForm.targetMargin}
 ...
 <div className="dpe-form-grid">
 <input
 type="text"placeholder="Product ID"value={aiRecForm.productId}
 onChange={(e) => setAIRecForm({ ...aiRecForm, productId: e.target.value })}
 />
 <textarea
 placeholder="Historical Data (JSON)"value={aiRecForm.historicalData}
 onChange={(e) => setAIRecForm({ ...aiRecForm, historicalData: e.target.value })}
 />
 <textarea
 placeholder="Market Conditions"value={aiRecForm.marketConditions}
