    ...
    <div className="aura-card flagship-churn-dashboard tool-main-flex" style={{ padding: 0, boxShadow: "0 8px 32px #0006" }}>
      ...
      <div className="churn-header" style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", padding: "36px 48px 0 48px" }}>
        <div style={{ flex: 2 }}>
          ...
          <div style={{ marginTop: 18, fontSize: 16, color: "#6366f1" }}>
      ...
      <div className="churn-segmentation" style={{ padding: "32px 48px", display: "flex", gap: 32 }}>
        <div style={{ flex: 2 }}>
          ...
          <div style={{ display: "flex", gap: 18, marginBottom: 18 }}>
            ...
            <button className="aura-btn" style={{ background: "#22c55e", color: "#0d0d11", fontWeight: 700 }}>Analyze</button>
          </div>
          {/* Cohort Analysis Chart Placeholder */}
          <div style={{ background: "#0d0d11", borderRadius: 18, padding: 24, minHeight: 180, marginBottom: 18 }}>
            <div style={{ fontWeight: 700, color: "#6366f1", fontSize: 18 }}>Cohort Analysis</div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 18 }}>
          <div style={{ background: "#0d0d11", borderRadius: 18, padding: 18 }}>
            <div style={{ fontWeight: 700, color: "#6366f1", fontSize: 18 }}>Retention Playbook Builder</div>
            <div style={{ color: "#b6eaff", fontSize: 15 }}>Design automated retention workflows, triggers, and actions (builder UI here)</div>
          </div>
          <div style={{ background: "#0d0d11", borderRadius: 18, padding: 18 }}>
            <div style={{ fontWeight: 700, color: "#6366f1", fontSize: 18 }}>Workflow Triggers</div>
      ...
      <div className="churn-playbook-library" style={{ padding: "32px 48px" }}>
        ...
        <div style={{ display: "flex", gap: 24 }}>
          ...
          <div style={{ flex: 2, background: "#0d0d11", borderRadius: 18, padding: 24, minHeight: 180 }}>
            <div style={{ fontWeight: 700, color: "#6366f1", fontSize: 18 }}>Playbook Library</div>
            <div style={{ color: "#b6eaff", fontSize: 15 }}>Browse, edit, and deploy retention playbooks (library UI here)</div>
          </div>
          {/* Bulk Actions */}
          <div style={{ flex: 1, background: "#0d0d11", borderRadius: 18, padding: 18 }}>
      ...
      <div className="churn-analytics-reporting" style={{ padding: "32px 48px" }}>
        ...
        <div style={{ display: "flex", gap: 24 }}>
          <div style={{ flex: 2, background: "#0d0d11", borderRadius: 18, padding: 24, minHeight: 180 }}>
            <div style={{ fontWeight: 700, color: "#6366f1", fontSize: 18 }}>Churn Analytics Dashboard</div>
