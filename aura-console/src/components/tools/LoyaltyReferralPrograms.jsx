...
const LoyaltyReferralPrograms = () => {
 ...
 <TextField
 size="small"placeholder="Search programs..."value={searchTerm}
 ...
 <Select
 value={filterStatus}
 label="Status"onChange={(e) => setFilterStatus(e.target.value)}
 >
 ...
 size="small"color={getStatusColor(program.status)}
 />
 </TableCell>
 ...
 <IconButton
 size="small"onClick={() => openDialog('viewProgram', program)}
 >
 <ViewIcon />
 </IconButton>
 <IconButton
 size="small"onClick={() => openDialog('editProgram', program)}
 >
 <EditIcon />
 </IconButton>
 <IconButton
 size="small"onClick={() => deleteProgram(program.id)}
 color="error">
 <DeleteIcon />
 </IconButton>
 </TableCell>
 ...
 size="small"color={getStatusColor(campaign.status)}
 />
 </TableCell>
 ...
 <ListItemText
 primary="Free Shipping"primaryTypographyProps={{ variant: 'body2'}}
 />
 </ListItem>
 )}
 ...
 <ListItemText
 primary="Exclusive Access"primaryTypographyProps={{ variant: 'body2'}}
 />
 </ListItem>
 )}
 </List>
 ...
 placeholder="Search members by name, email..."value={searchTerm}
 onChange={(e) => setSearchTerm(e.target.value)}
 InputProps={{
 startAdornment: <SearchIcon sx={{ mr: 1, color: 'text.secondary'}} />,
 }}
 ...
 size="small"sx={{ bgcolor: getTierColor(member.tier), color: 'white'}}
 />
 </TableCell>
 ...
 <Chip
 label={tier.tier}
 size="small"sx={{ bgcolor: getTierColor(tier.tier), color: 'white'}}
 />
 </TableCell>
 ...
 <LinearProgress
 variant="determinate"value={stage.percentage * 100}
