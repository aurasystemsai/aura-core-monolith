...
const UpsellCrossSellEngine = () => {
 ...
 <input
 type="text"value={recommendationForm.customerId}
 ...
 <input
 type="number"value={recommendationForm.maxRecommendations}
 ...
 <input
 type="number"step="0.01"value={affinityForm.minSupport}
 ...
 <input
 type="number"step="0.05"value={affinityForm.minConfidence}
 ...
 <input
 type="number"step="0.1"value={affinityForm.minLift}
 ...
 <input
 type="text"value={cartForm.cartId}
 ...
 <input
 type="email"value={cartForm.customerEmail}
