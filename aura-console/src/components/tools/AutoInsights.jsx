    ...
    <div className="aura-card flagship-autoinsights-dashboard" style={{ padding: 0, background: "var(--surface-card)", borderRadius: 24, boxShadow: "0 8px 32px #0006" }}>
      ...
      <div className="autoinsights-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "36px 48px 0 48px" }}>
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div className="insight-score-card" style={{ background: "#18181b", borderRadius: 18, padding: "18px 32px", boxShadow: "0 2px 16px #0003", textAlign: "center" }}>
            <div style={{ fontWeight: 800, fontSize: 22, color: "#818cf8" }}>Insight Score</div>
          ...
          <button className="aura-btn" style={{ background: '#818cf8', color: '#09090b', fontWeight: 800 }} onClick={simulateIngest}>Refresh data</button>
        </div>
      </div>
      ...
      <div className="autoinsights-segmentation" style={{ padding: "32px 48px", display: "flex", gap: 32 }}>
        <div style={{ flex: 2 }}>
          ...
          <div style={{ display: "flex", gap: 18, marginBottom: 18 }}>
            ...
            <button className="aura-btn" style={{ background: "#818cf8", color: "#09090b", fontWeight: 700 }} onClick={handleFilter}>Filter</button>
          </div>
          ...
          <div style={{ background: "#09090b", borderRadius: 18, padding: 24, minHeight: 180, marginBottom: 18 }}>
            <div style={{ fontWeight: 700, color: "#818cf8", fontSize: 18 }}>Analytics & Trends</div>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            {exportUrl && <a href={exportUrl} download="segment-snapshot.json" style={{ color: '#818cf8', textDecoration: 'underline', fontSize: 13 }}>Download snapshot</a>}
      ...
      <div className="autoinsights-analytics-reporting" style={{ padding: "32px 48px" }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div style={{ background: "#09090b", borderRadius: 18, padding: 18 }}>
              ...
              <div style={{ marginTop: 10, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                ...
                {exportUrl && <a href={exportUrl} download="exec-summary.txt" style={{ color: '#818cf8', textDecoration: 'underline', fontSize: 13 }}>Download</a>}
        ...
        <div style={{ marginTop: 16, display: 'flex', gap: 12, flexWrap: 'wrap', background: '#18181b', borderRadius: 14, padding: 14, border: '1px solid #27272a' }}>
          <div style={{ fontWeight: 800, color: '#818cf8' }}>Shopify metric presets</div>
      ...
      <div style={{ padding: "0 48px 24px" }}>
        <div style={{ display: 'grid', gap: 18, gridTemplateColumns: 'minmax(240px, 1.2fr) minmax(240px, 1fr)' }}>
          <div style={{ background: '#09090b', borderRadius: 18, padding: 18 }}>
            <div style={{ fontWeight: 800, color: '#818cf8', fontSize: 18, marginBottom: 8 }}>Pinboard</div>
              ...
              <div style={{ display: 'grid', gap: 10 }}>
                {pinboard.map(pin => (
                  <div key={pin.id} style={{ background: '#18181b', borderRadius: 10, padding: 10, border: '1px solid #27272a' }}>
                    ...
                    {pin.comments && pin.comments.length > 0 && <div style={{ color: '#818cf8', fontSize: 12 }}>Comments: {pin.comments.join(' · ')}</div>}
          ...
          <div style={{ background: '#09090b', borderRadius: 18, padding: 18 }}>
            <div style={{ fontWeight: 800, color: '#818cf8', fontSize: 18, marginBottom: 8 }}>Why this insight?</div>
      ...
      <div style={{ padding: "0 48px 24px" }}>
        <div style={{ display: 'grid', gap: 18, gridTemplateColumns: 'minmax(240px, 1fr) minmax(240px, 1fr)' }}>
          <div style={{ background: '#09090b', borderRadius: 18, padding: 18 }}>
            <div style={{ fontWeight: 800, color: '#818cf8', fontSize: 18, marginBottom: 8 }}>Why did this change?</div>
          ...
          <div style={{ background: '#09090b', borderRadius: 18, padding: 18 }}>
            <div style={{ fontWeight: 800, color: '#818cf8', fontSize: 18, marginBottom: 8 }}>Anomaly stream</div>
            <div style={{ display: 'grid', gap: 10 }}>
              {anomalies.map(a => (
                <div key={a.id} style={{ display: 'grid', gap: 8, background: '#18181b', borderRadius: 10, padding: '10px 12px', border: '1px solid #27272a' }}>
                  ...
                  <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    <button className="aura-btn" style={{ background: '#818cf8', color: '#09090b' }} onClick={() => routeAlert('email')}>Email alert</button>
      ...
      <div style={{ padding: "0 48px 36px", display: 'grid', gap: 18, gridTemplateColumns: 'minmax(260px, 1fr) minmax(260px, 1fr)' }}>
        <div style={{ background: '#09090b', borderRadius: 18, padding: 18 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
            <div style={{ fontWeight: 800, color: '#818cf8', fontSize: 18 }}>Comparison mode</div>
        ...
        <div style={{ background: '#09090b', borderRadius: 18, padding: 18, display: 'grid', gap: 10 }}>
          <div style={{ fontWeight: 800, color: '#818cf8', fontSize: 18 }}>AI assist</div>
        ...
        <div style={{ background: '#09090b', borderRadius: 18, padding: 18, display: 'grid', gap: 10 }}>
          <div style={{ fontWeight: 800, color: '#818cf8', fontSize: 18 }}>Scenario simulator</div>
      ...
      <div style={{ padding: "0 48px 24px" }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ fontWeight: 800, color: '#818cf8', fontSize: 18 }}>Debug panel</div>
