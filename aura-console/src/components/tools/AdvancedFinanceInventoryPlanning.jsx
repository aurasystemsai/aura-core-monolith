    ...
    <div style={{ color: palette.text, background: palette.bg, padding: 12, borderRadius: 12 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <button
            onClick={saveVersion}
            style={{ padding: "8px 12px", borderRadius: 10, border: `1px solid ${palette.accent}`, background: palette.accent, color: "#1f2433", fontWeight: 800, cursor: "pointer" }}
          >
            Save Version
          </button>
        </div>
      ...
      <div style={{ display: "grid", gap: 12, marginTop: 12 }}>
          ...
          <div style={{ display: "grid", gap: 8, marginTop: 10 }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              <button
                ...
                style={{ background: palette.accent, color: "#1f2433", border: `1px solid ${palette.accent}`, borderRadius: 10, padding: "10px 18px", fontWeight: 800, cursor: loading || !query ? "not-allowed" : "pointer" }}
              >
        ...
        {result && (
          <div style={{ ...paletteCard, background: theme === "light" ? "#ecfeff" : "#1f2433" }}>
