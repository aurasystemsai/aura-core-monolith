      ...
      {open && (
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
            <h2 style={{ color: darkMode ? "#a3e635" : "#23263a", fontWeight: 900, fontSize: 22, margin: 0 }}>Abandoned Checkout Winback: Help & Docs</h2>
            <button onClick={() => setDarkMode(d => !d)} aria-label="Toggle dark mode" style={{ background: "none", color: darkMode ? "#a3e635" : "#23263a", border: "none", fontWeight: 700, fontSize: 16, cursor: "pointer" }}>{darkMode ? "☀️" : "🌙"}</button>
          </div>
          <input
            ref={inputRef}
            value={search}
            ...
            style={{ width: "100%", fontSize: 15, padding: 8, borderRadius: 8, border: darkMode ? "1px solid #333" : "1px solid #ccc", marginBottom: 14, background: darkMode ? "#23263a" : "#fff", color: darkMode ? "#a3e635" : "#23263a" }}
