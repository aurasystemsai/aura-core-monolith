...
export default function WinbackHelpDocs() {
 ...
 <button onClick={() => setDarkMode(d => !d)} aria-label="Toggle dark mode"style={{ background: "none", color: darkMode ? "#a3e635": "#09090b", border: "none", fontWeight: 700, fontSize: 16, cursor: "pointer"}}>{darkMode ? "": ""}</button>
 </div>
 <input
 ref={inputRef}
 value={search}
 onChange={e => setSearch(e.target.value)}
 placeholder="Search help topics..."style={{ width: "100%", fontSize: 15, padding: 8, borderRadius: 8, border: darkMode ? "1px solid #333": "1px solid #ccc", marginBottom: 14, background: darkMode ? "#09090b": "#fff", color: darkMode ? "#a3e635": "#09090b"}}
 ...
 placeholder="Ask a question..."style={{ flex: 1, fontSize: 15, padding: 8, borderRadius: 8, border: darkMode ? "1px solid #333": "1px solid #ccc", background: darkMode ? "#09090b": "#fff", color: darkMode ? "#a3e635": "#09090b"}}
 ...
 placeholder="Share feedback or suggestions..."style={{ flex: 1, fontSize: 15, padding: 8, borderRadius: 8, border: darkMode ? "1px solid #333": "1px solid #ccc", background: darkMode ? "#09090b": "#fff", color: darkMode ? "#a3e635": "#09090b"}}
