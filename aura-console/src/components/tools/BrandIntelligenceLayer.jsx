...
export default function BrandIntelligenceLayer() {
  ...
  return (
    <div className="tool-main-flex" style={{
      ...
      {response && (
        <div style={{ marginTop: 32, background: "#0a0a0a", borderRadius: 12, padding: 24 }}>
          <div style={{ fontWeight: 600, fontSize: 18, marginBottom: 8 }}>AI Response:</div>
          <div style={{ fontSize: 16, color: "#a3e635" }}>{response}</div>
        </div>
      )}
      {history.length > 0 && (
        <div style={{ marginTop: 32, background: "#0a0a0a", borderRadius: 12, padding: 20 }}>
      ...
      <form
        ...
        style={{ marginTop: 32, background: "#0a0a0a", color: "#f3f4f6", borderRadius: 12, padding: 20 }}
      ...
      >
        ...
        <textarea
          ...
          rows={2}
          style={{ width: "100%", fontSize: 15, padding: 10, borderRadius: 8, border: "1px solid #555", marginBottom: 12, background: "#0a0a0a", color: "#a3e635" }}
