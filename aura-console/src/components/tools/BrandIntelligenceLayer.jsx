...
export default function BrandIntelligenceLayer() {
  ...
  const onboardingContent = (
    <div style={{ padding: 24, background: "#0d0d11", borderRadius: 12, marginBottom: 18 }}>
      ...
      <button onClick={() => setShowOnboarding(false)} style={{ marginTop: 18, background: "#0d0d11", color: "#f3f4f6", border: "none", borderRadius: 8, padding: "10px 28px", fontWeight: 600, fontSize: 16, cursor: "pointer" }}>Get Started</button>
    </div>
  );
  ...
  return (
    <div className="tool-main-flex" style={{
      ...
      {response && (
        <div style={{ marginTop: 32, background: "#0d0d11", borderRadius: 12, padding: 24 }}>
          <div style={{ fontWeight: 600, fontSize: 18, marginBottom: 8 }}>AI Response:</div>
          <div style={{ fontSize: 16, color: "#a3e635" }}>{response}</div>
        </div>
      )}
      {history.length > 0 && (
        <div style={{ marginTop: 32, background: "#0d0d11", borderRadius: 12, padding: 20 }}>
      ...
      <form
        ...
        style={{ marginTop: 32, background: "#0d0d11", color: "#f3f4f6", borderRadius: 12, padding: 20 }}
      ...
      >
        ...
        <textarea
          ...
          rows={2}
          style={{ width: "100%", fontSize: 15, padding: 10, borderRadius: 8, border: "1px solid #555", marginBottom: 12, background: "#0d0d11", color: "#a3e635" }}
          placeholder="Share your feedback or suggestions..."
          aria-label="Feedback input"
        />
        <button
          type="submit"
          style={{ background: "#6366f1", color: "#0d0d11", border: "none", borderRadius: 8, padding: "10px 24px", fontWeight: 600, fontSize: 15, cursor: "pointer" }}
        >
          Send Feedback
        </button>
      </form>
