...
export default function BrandIntelligenceLayer() {
  ...
  const onboardingContent = (
    <div style={{ padding: 24, background: "#09090b", borderRadius: 12, marginBottom: 18 }}>
      ...
      <button onClick={() => setShowOnboarding(false)} style={{ marginTop: 18, background: "#09090b", color: "#f3f4f6", border: "none", borderRadius: 8, padding: "10px 28px", fontWeight: 600, fontSize: 16, cursor: "pointer" }}>Get Started</button>
    </div>
  );
  ...
  return (
    <div className="tool-main-flex" style={{
      ...
      <form
        ...
        style={{ marginTop: 32, background: "#09090b", color: "#f3f4f6", borderRadius: 12, padding: 20 }}
