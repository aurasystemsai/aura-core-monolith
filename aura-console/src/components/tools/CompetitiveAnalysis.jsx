  ...
  return (
    <div className="aura-card flagship-competitive-dashboard" style={{ padding: 0, background: "var(--surface-card)", borderRadius: 24, boxShadow: "0 8px 32px #0006" }}>
      ...
      <div className="competitive-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "36px 48px 0 48px" }}>
        ...
        <div className="benchmark-score-card" style={{ background: "#1f2433", borderRadius: 18, padding: "18px 32px", boxShadow: "0 2px 16px #0003", textAlign: "center" }}>
          <div style={{ fontWeight: 800, fontSize: 22, color: "#4f46e5" }}>Benchmark Score</div>
      ...
      <div className="competitive-segmentation" style={{ padding: "32px 48px", display: "flex", gap: 32 }}>
        <div style={{ flex: 2 }}>
          ...
          <div style={{ display: "flex", gap: 18, marginBottom: 18 }}>
            ...
            <button className="aura-btn" style={{ background: "#4f46e5", color: "#0a0b0f", fontWeight: 700 }}>Filter</button>
          </div>
          ...
          <div style={{ background: "#0a0b0f", borderRadius: 18, padding: 24, minHeight: 180, marginBottom: 18 }}>
            <div style={{ fontWeight: 700, color: "#4f46e5", fontSize: 18 }}>Feature Gap Analysis</div>
