    ...
    <div className="abtest-flagship" style={{ padding: 32 }}>
                ...
                {variants.map((v, i) => (
                  <div key={i} style={{ flex: 1, background: '#27272a', borderRadius: 8, padding: 16, minHeight: 120, marginBottom: 8, boxShadow: '0 2px 8px #0002' }}>
                    ...
                    <textarea
                      ...
                      style={{ width: '100%', minHeight: 60, borderRadius: 6, border: '1px solid #52525b', padding: 8, fontSize: 15, background: '#18181b', color: '#e0e6ed' }}
                    />
                  </div>
                ))}
              </div>
      ...
      <section className="abtest-analytics" style={{ background: '#18181b', borderRadius: 16, padding: 32, marginBottom: 40 }}>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <table style={{ width: '100%', marginTop: 8, background: '#27272a', borderRadius: 8, color: '#e0e6ed', fontSize: 15 }}>
            <thead>
        ...
        <div style={{ display: 'flex', gap: 32 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ background: '#27272a', borderRadius: 8, padding: 16, minHeight: 120, color: '#e0e6ed' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ background: '#27272a', borderRadius: 8, padding: 16, minHeight: 120, color: '#e0e6ed', fontSize: 15 }}>
      ...
      <section className="abtest-integrations" style={{ background: '#18181b', borderRadius: 16, padding: 32, marginBottom: 40 }}>
        ...
        <div style={{ display: 'flex', gap: 32 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ background: '#27272a', borderRadius: 8, padding: 16, minHeight: 80, color: '#e0e6ed' }}>
