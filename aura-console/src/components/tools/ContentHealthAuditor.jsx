    ...
    <div>
      <div style={{ background: "#1f2433", borderRadius: 18, boxShadow: "0 2px 24px #0008", padding: 36, fontFamily: 'Inter, sans-serif', color: '#f6f7fb' }}>
        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 18 }}>
          <button onClick={handleRun} disabled={loading || !input} style={{ background: "#4f46e5", color: "#0a0b0f", border: "none", borderRadius: 8, padding: "10px 22px", fontWeight: 700, fontSize: 16, cursor: "pointer" }}>{loading ? "Auditing..." : "AI Audit"}</button>
        ...
        {response && (
          <div style={{ background: "#283044", borderRadius: 10, padding: 16, marginBottom: 12, border: "1px solid #283044" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
              <span style={{ fontWeight: 700, color: "#4f46e5", fontSize: 14 }}>AI Audit Report</span>
