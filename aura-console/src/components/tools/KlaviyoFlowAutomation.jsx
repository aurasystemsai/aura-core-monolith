...
export default function KlaviyoFlowAutomation() {
  ...
  const renderFlowsList = () => (
    <div style={{ padding: 24 }}>
      ...
      {flows.length > 0 && (
        <div style={{ background: '#2e3045', borderRadius: 12, overflow: 'hidden' }}>
  ...
  const renderFlowsEditor = () => (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ background: '#2e3045', borderRadius: 12, padding: 48, textAlign: 'center', minHeight: 400 }}>
  ...
  const renderFlowOptimizer = () => (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ background: '#2e3045', borderRadius: 12, padding: 24 }}>
  ...
  const renderAuditLogs = () => (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ background: '#2e3045', borderRadius: 12, padding: 16 }}>
        {auditLogs.length === 0 && (
  ...
  const renderAIOrchestration = () => (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ background: '#2e3045', borderRadius: 12, padding: 24, marginBottom: 24 }}>
  ...
  return (
    <div style={containerStyle}>
      {/* Header */}
      <div style={{
        background: theme === 'dark' ? '#2e3045' : '#f5f5f5',
      ...
      <div style={{
        ...
        {tabGroups[navCategory].map(tab => (
          <button
            ...
            style={{
              background: activeTab === tab.id ? theme === 'dark' ? '#2e3045' : '#fff' : 'transparent',
