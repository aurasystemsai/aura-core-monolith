...
export default function KlaviyoFlowAutomation() {
  ...
  const renderFlowsList = () => (
    <div style={{ padding: 24 }}>
      ...
      {flows.length > 0 && (
        <div style={{ background: '#222535', borderRadius: 12, overflow: 'hidden' }}>
  ...
  const renderFlowsEditor = () => (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ background: '#222535', borderRadius: 12, padding: 48, textAlign: 'center', minHeight: 400 }}>
  ...
  const renderAIOrchestration = () => (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ background: '#222535', borderRadius: 12, padding: 24, marginBottom: 24 }}>
