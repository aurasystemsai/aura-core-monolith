...
export default function SelfServiceAnalytics() {
 ...
 { label: "GrossNet by payment (30d)", metric: "gross_to_net", dimension: "payment_gateway", range: "30d"},
 ];
 ...
 placeholder="> 5000"disabled={!alertEnabled}
 />
 <select
 value={alertChannel}
