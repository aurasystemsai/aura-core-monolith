...
const ONBOARDING_STEPS = [
  ...
  { key: "explore-docs", label: "Explore the documentation",
    help: <a href="https://aurasystemsai.com/docs" target="_blank" rel="noopener" style={{color:'#7fffd4',textDecoration:'underline'}}>Open docs ↗</a> },
...
export default function OnboardingChecklist({ onComplete, forceShow, onClose }) {
  ...
  return (
    <div style={{
      position: 'fixed', bottom: 32, right: 32, zIndex: 9999, background: '#141414', color: '#fff', borderRadius: 14, boxShadow: '0 4px 24px #0008', padding: '24px 32px', minWidth: 260, maxWidth: 360, fontSize: 16, fontWeight: 500, letterSpacing: '0.01em', animation: 'fadeIn 0.4s', border: '1.5px solid #7fffd4',
    }}>
