...
function ProjectSetup({ coreUrl, onConnected }) {
 ...
 Store Name
 <input
 type="text"placeholder="Enter your store name"value={name}
 ...
 Main Domain
 <input
 type="text"placeholder="Enter your main domain"value={domain}
 ...
 <button
 type="submit"className="button button--primary"disabled={loading}
 style={{ marginTop: 8 }}
 >
